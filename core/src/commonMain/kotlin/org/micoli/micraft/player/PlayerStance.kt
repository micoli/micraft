...
enum class PlayerStance {
    STANDING, SNEAKING, CRAWLING;
}

val PlayerStance.height: Float get() = when (this) {
...
val PlayerStance.eyeOffset: Float get() = when (this) {
...
val PlayerStance.speed: Float get() = when (this) {
