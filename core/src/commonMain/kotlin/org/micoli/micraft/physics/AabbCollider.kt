...
object AabbCollider {
    ...
    fun resolveX(isSolid: (Int, Int, Int) -> Boolean, cx: Float, cy: Float, cz: Float, w: Float, h: Float, dx: Float): Float {
        if (dx == 0f) return 0f
        val hw = w / 2f
        val newCx = cx + dx
    ...
    fun resolveZ(isSolid: (Int, Int, Int) -> Boolean, cx: Float, cy: Float, cz: Float, w: Float, h: Float, dz: Float): Float {
        if (dz == 0f) return 0f
        val hw = w / 2f
        val newCz = cz + dz
        val ys = blocks(cy, cy + h)
    ...
    fun resolveY(isSolid: (Int, Int, Int) -> Boolean, cx: Float, cy: Float, cz: Float, w: Float, h: Float, dy: Float): Float {
        if (dy == 0f) return 0f
        val hw = w / 2f
        val xs = blocks(cx - hw, cx + hw)
        val zs = blocks(cz - hw, cz + hw)
    ...
    fun canAdoptStance(isSolid: (Int, Int, Int) -> Boolean, cx: Float, cy: Float, cz: Float, w: Float, newH: Float, currentH: Float): Boolean {
