...
sealed class ClientMessage {
    ...
    /**
     * Siege-specific: nudge the targeted weapon's power by one step in its current direction
     * (server-owned; bounces between `launchPowerMin`/`launchPowerMax` — see
