 ...
 */
export const useGetAuthMeSuspense = <TData = NonNullable<Common.GetAuthMeDefaultResponse>, TError = unknown, TQueryKey extends Array<unknown> = unknown[]>(clientOptions: Options<GetAuthMeData, true> = {}, queryKey?: TQueryKey, options?: Omit<UseSuspenseQueryOptions<TData, TError>, "queryKey" | "queryFn">) => useSuspenseQuery<TData, TError>({ queryKey: Common.UseGetAuthMeKeyFn(clientOptions, queryKey), queryFn: ({ signal }) => getAuthMe({ ...clientOptions, signal, throwOnError: true }).then(response => response.data as TData) as TData, ...options });
/**
 * Redirect to the OAuth provider's consent screen
 */
export const useGetAuthOauthStartSuspense = <TData = NonNullable<Common.GetAuthOauthStartDefaultResponse>, TError = unknown, TQueryKey extends Array<unknown> = unknown[]>(clientOptions: Options<GetAuthOauthStartData, true> = {}, queryKey?: TQueryKey, options?: Omit<UseSuspenseQueryOptions<TData, TError>, "queryKey" | "queryFn">) => useSuspenseQuery<TData, TError>({ queryKey: Common.UseGetAuthOauthStartKeyFn(clientOptions, queryKey), queryFn: ({ signal }) => getAuthOauthStart({ ...clientOptions, signal, throwOnError: true }).then(response => response.data as TData) as TData, ...options });
/**
 * OAuth authorization code callback — redirects with the session token in the URL fragment
 */
export const useGetAuthCallbackSuspense = <TData = NonNullable<Common.GetAuthCallbackDefaultResponse>, TError = unknown, TQueryKey extends Array<unknown> = unknown[]>(clientOptions: Options<GetAuthCallbackData, true> = {}, queryKey?: TQueryKey, options?: Omit<UseSuspenseQueryOptions<TData, TError>, "queryKey" | "queryFn">) => useSuspenseQuery<TData, TError>({ queryKey: Common.UseGetAuthCallbackKeyFn(clientOptions, queryKey), queryFn: ({ signal }) => getAuthCallback({ ...clientOptions, signal, throwOnError: true }).then(response => response.data as TData) as TData, ...options });
 ...
 */
export const useGetApiBiomesTintsSuspense = <TData = NonNullable<Common.GetApiBiomesTintsDefaultResponse>, TError = unknown, TQueryKey extends Array<unknown> = unknown[]>(clientOptions: Options<GetApiBiomesTintsData, true> = {}, queryKey?: TQueryKey, options?: Omit<UseSuspenseQueryOptions<TData, TError>, "queryKey" | "queryFn">) => useSuspenseQuery<TData, TError>({ queryKey: Common.UseGetApiBiomesTintsKeyFn(clientOptions, queryKey), queryFn: ({ signal }) => getApiBiomesTints({ ...clientOptions, signal, throwOnError: true }).then(response => response.data as TData) as TData, ...options });
/**
 ...
 */
export const useGetApiVehiclesByNameConfigSuspense = <TData = NonNullable<Common.GetApiVehiclesByNameConfigDefaultResponse>, TError = unknown, TQueryKey extends Array<unknown> = unknown[]>(clientOptions: Options<GetApiVehiclesByNameConfigData, true>, queryKey?: TQueryKey, options?: Omit<UseSuspenseQueryOptions<TData, TError>, "queryKey" | "queryFn">) => useSuspenseQuery<TData, TError>({ queryKey: Common.UseGetApiVehiclesByNameConfigKeyFn(clientOptions, queryKey), queryFn: ({ signal }) => getApiVehiclesByNameConfig({ ...clientOptions, signal, throwOnError: true }).then(response => response.data as TData) as TData, ...options });
/**
 ...
 */
export const useGetApiMinigamesSuspense = <TData = NonNullable<Common.GetApiMinigamesDefaultResponse>, TError = unknown, TQueryKey extends Array<unknown> = unknown[]>(clientOptions: Options<GetApiMinigamesData, true> = {}, queryKey?: TQueryKey, options?: Omit<UseSuspenseQueryOptions<TData, TError>, "queryKey" | "queryFn">) => useSuspenseQuery<TData, TError>({ queryKey: Common.UseGetApiMinigamesKeyFn(clientOptions, queryKey), queryFn: ({ signal }) => getApiMinigames({ ...clientOptions, signal, throwOnError: true }).then(response => response.data as TData) as TData, ...options });
/**
 ...
 */
export const useGetApiSiegeWeaponsSuspense = <TData = NonNullable<Common.GetApiSiegeWeaponsDefaultResponse>, TError = unknown, TQueryKey extends Array<unknown> = unknown[]>(clientOptions: Options<GetApiSiegeWeaponsData, true> = {}, queryKey?: TQueryKey, options?: Omit<UseSuspenseQueryOptions<TData, TError>, "queryKey" | "queryFn">) => useSuspenseQuery<TData, TError>({ queryKey: Common.UseGetApiSiegeWeaponsKeyFn(clientOptions, queryKey), queryFn: ({ signal }) => getApiSiegeWeapons({ ...clientOptions, signal, throwOnError: true }).then(response => response.data as TData) as TData, ...options });
/**
 * List all furniture definitions
 */
export const useGetApiFurnituresSuspense = <TData = NonNullable<Common.GetApiFurnituresDefaultResponse>, TError = unknown, TQueryKey extends Array<unknown> = unknown[]>(clientOptions: Options<GetApiFurnituresData, true> = {}, queryKey?: TQueryKey, options?: Omit<UseSuspenseQueryOptions<TData, TError>, "queryKey" | "queryFn">) => useSuspenseQuery<TData, TError>({ queryKey: Common.UseGetApiFurnituresKeyFn(clientOptions, queryKey), queryFn: ({ signal }) => getApiFurnitures({ ...clientOptions, signal, throwOnError: true }).then(response => response.data as TData) as TData, ...options });
/**
 * List all auction listings, any status
 */
export const useGetApiAdminAuctionsSuspense = <TData = NonNullable<Common.GetApiAdminAuctionsDefaultResponse>, TError = unknown, TQueryKey extends Array<unknown> = unknown[]>(clientOptions: Options<GetApiAdminAuctionsData, true> = {}, queryKey?: TQueryKey, options?: Omit<UseSuspenseQueryOptions<TData, TError>, "queryKey" | "queryFn">) => useSuspenseQuery<TData, TError>({ queryKey: Common.UseGetApiAdminAuctionsKeyFn(clientOptions, queryKey), queryFn: ({ signal }) => getApiAdminAuctions({ ...clientOptions, signal, throwOnError: true }).then(response => response.data as TData) as TData, ...options });
/**
 ...
 */
export const useGetApiAdminPermissionsSuspense = <TData = NonNullable<Common.GetApiAdminPermissionsDefaultResponse>, TError = unknown, TQueryKey extends Array<unknown> = unknown[]>(clientOptions: Options<GetApiAdminPermissionsData, true> = {}, queryKey?: TQueryKey, options?: Omit<UseSuspenseQueryOptions<TData, TError>, "queryKey" | "queryFn">) => useSuspenseQuery<TData, TError>({ queryKey: Common.UseGetApiAdminPermissionsKeyFn(clientOptions, queryKey), queryFn: ({ signal }) => getApiAdminPermissions({ ...clientOptions, signal, throwOnError: true }).then(response => response.data as TData) as TData, ...options });
/**
 * All permission groups, including the virtual admin group
 */
export const useGetApiAdminGroupsSuspense = <TData = NonNullable<Common.GetApiAdminGroupsDefaultResponse>, TError = unknown, TQueryKey extends Array<unknown> = unknown[]>(clientOptions: Options<GetApiAdminGroupsData, true> = {}, queryKey?: TQueryKey, options?: Omit<UseSuspenseQueryOptions<TData, TError>, "queryKey" | "queryFn">) => useSuspenseQuery<TData, TError>({ queryKey: Common.UseGetApiAdminGroupsKeyFn(clientOptions, queryKey), queryFn: ({ signal }) => getApiAdminGroups({ ...clientOptions, signal, throwOnError: true }).then(response => response.data as TData) as TData, ...options });
/**
 * All player names
 */
 ...
 */
export const useGetApiAdminPlayersByNameGroupsSuspense = <TData = NonNullable<Common.GetApiAdminPlayersByNameGroupsDefaultResponse>, TError = unknown, TQueryKey extends Array<unknown> = unknown[]>(clientOptions: Options<GetApiAdminPlayersByNameGroupsData, true>, queryKey?: TQueryKey, options?: Omit<UseSuspenseQueryOptions<TData, TError>, "queryKey" | "queryFn">) => useSuspenseQuery<TData, TError>({ queryKey: Common.UseGetApiAdminPlayersByNameGroupsKeyFn(clientOptions, queryKey), queryFn: ({ signal }) => getApiAdminPlayersByNameGroups({ ...clientOptions, signal, throwOnError: true }).then(response => response.data as TData) as TData, ...options });
/**
 ...
 */
export const useGetApiAdminLoggersSuspense = <TData = NonNullable<Common.GetApiAdminLoggersDefaultResponse>, TError = unknown, TQueryKey extends Array<unknown> = unknown[]>(clientOptions: Options<GetApiAdminLoggersData, true> = {}, queryKey?: TQueryKey, options?: Omit<UseSuspenseQueryOptions<TData, TError>, "queryKey" | "queryFn">) => useSuspenseQuery<TData, TError>({ queryKey: Common.UseGetApiAdminLoggersKeyFn(clientOptions, queryKey), queryFn: ({ signal }) => getApiAdminLoggers({ ...clientOptions, signal, throwOnError: true }).then(response => response.data as TData) as TData, ...options });
/**
 ...
 * All land claims
 */
export const useGetApiAdminClaimsSuspense = <TData = NonNullable<Common.GetApiAdminClaimsDefaultResponse>, TError = unknown, TQueryKey extends Array<unknown> = unknown[]>(clientOptions: Options<GetApiAdminClaimsData, true> = {}, queryKey?: TQueryKey, options?: Omit<UseSuspenseQueryOptions<TData, TError>, "queryKey" | "queryFn">) => useSuspenseQuery<TData, TError>({ queryKey: Common.UseGetApiAdminClaimsKeyFn(clientOptions, queryKey), queryFn: ({ signal }) => getApiAdminClaims({ ...clientOptions, signal, throwOnError: true }).then(response => response.data as TData) as TData, ...options });
/**
 * A single land claim
 */
export const useGetApiAdminClaimsByIdSuspense = <TData = NonNullable<Common.GetApiAdminClaimsByIdDefaultResponse>, TError = unknown, TQueryKey extends Array<unknown> = unknown[]>(clientOptions: Options<GetApiAdminClaimsByIdData, true>, queryKey?: TQueryKey, options?: Omit<UseSuspenseQueryOptions<TData, TError>, "queryKey" | "queryFn">) => useSuspenseQuery<TData, TError>({ queryKey: Common.UseGetApiAdminClaimsByIdKeyFn(clientOptions, queryKey), queryFn: ({ signal }) => getApiAdminClaimsById({ ...clientOptions, signal, throwOnError: true }).then(response => response.data as TData) as TData, ...options });
/**
 ...
 */
export const useGetApiAdminSocialOnlinePlayersSuspense = <TData = NonNullable<Common.GetApiAdminSocialOnlinePlayersDefaultResponse>, TError = unknown, TQueryKey extends Array<unknown> = unknown[]>(clientOptions: Options<GetApiAdminSocialOnlinePlayersData, true> = {}, queryKey?: TQueryKey, options?: Omit<UseSuspenseQueryOptions<TData, TError>, "queryKey" | "queryFn">) => useSuspenseQuery<TData, TError>({ queryKey: Common.UseGetApiAdminSocialOnlinePlayersKeyFn(clientOptions, queryKey), queryFn: ({ signal }) => getApiAdminSocialOnlinePlayers({ ...clientOptions, signal, throwOnError: true }).then(response => response.data as TData) as TData, ...options });
/**
 * Canonical display names of every known player (online + persisted), de-duplicated — for social name-field autocomplete
 */
export const useGetApiAdminSocialPlayersSuspense = <TData = NonNullable<Common.GetApiAdminSocialPlayersDefaultResponse>, TError = unknown, TQueryKey extends Array<unknown> = unknown[]>(clientOptions: Options<GetApiAdminSocialPlayersData, true> = {}, queryKey?: TQueryKey, options?: Omit<UseSuspenseQueryOptions<TData, TError>, "queryKey" | "queryFn">) => useSuspenseQuery<TData, TError>({ queryKey: Common.UseGetApiAdminSocialPlayersKeyFn(clientOptions, queryKey), queryFn: ({ signal }) => getApiAdminSocialPlayers({ ...clientOptions, signal, throwOnError: true }).then(response => response.data as TData) as TData, ...options });
/**
 * All active player groups
 */
export const useGetApiAdminSocialGroupsSuspense = <TData = NonNullable<Common.GetApiAdminSocialGroupsDefaultResponse>, TError = unknown, TQueryKey extends Array<unknown> = unknown[]>(clientOptions: Options<GetApiAdminSocialGroupsData, true> = {}, queryKey?: TQueryKey, options?: Omit<UseSuspenseQueryOptions<TData, TError>, "queryKey" | "queryFn">) => useSuspenseQuery<TData, TError>({ queryKey: Common.UseGetApiAdminSocialGroupsKeyFn(clientOptions, queryKey), queryFn: ({ signal }) => getApiAdminSocialGroups({ ...clientOptions, signal, throwOnError: true }).then(response => response.data as TData) as TData, ...options });
/**
 * All guilds
 */
export const useGetApiAdminSocialGuildsSuspense = <TData = NonNullable<Common.GetApiAdminSocialGuildsDefaultResponse>, TError = unknown, TQueryKey extends Array<unknown> = unknown[]>(clientOptions: Options<GetApiAdminSocialGuildsData, true> = {}, queryKey?: TQueryKey, options?: Omit<UseSuspenseQueryOptions<TData, TError>, "queryKey" | "queryFn">) => useSuspenseQuery<TData, TError>({ queryKey: Common.UseGetApiAdminSocialGuildsKeyFn(clientOptions, queryKey), queryFn: ({ signal }) => getApiAdminSocialGuilds({ ...clientOptions, signal, throwOnError: true }).then(response => response.data as TData) as TData, ...options });
/**
 * Faction settings and definitions
 */
export const useGetApiAdminSocialFactionsSuspense = <TData = NonNullable<Common.GetApiAdminSocialFactionsDefaultResponse>, TError = unknown, TQueryKey extends Array<unknown> = unknown[]>(clientOptions: Options<GetApiAdminSocialFactionsData, true> = {}, queryKey?: TQueryKey, options?: Omit<UseSuspenseQueryOptions<TData, TError>, "queryKey" | "queryFn">) => useSuspenseQuery<TData, TError>({ queryKey: Common.UseGetApiAdminSocialFactionsKeyFn(clientOptions, queryKey), queryFn: ({ signal }) => getApiAdminSocialFactions({ ...clientOptions, signal, throwOnError: true }).then(response => response.data as TData) as TData, ...options });
/**
 * Players affiliated with a faction (online + persisted)
 */
export const useGetApiAdminSocialFactionsByIdMembersSuspense = <TData = NonNullable<Common.GetApiAdminSocialFactionsByIdMembersDefaultResponse>, TError = unknown, TQueryKey extends Array<unknown> = unknown[]>(clientOptions: Options<GetApiAdminSocialFactionsByIdMembersData, true>, queryKey?: TQueryKey, options?: Omit<UseSuspenseQueryOptions<TData, TError>, "queryKey" | "queryFn">) => useSuspenseQuery<TData, TError>({ queryKey: Common.UseGetApiAdminSocialFactionsByIdMembersKeyFn(clientOptions, queryKey), queryFn: ({ signal }) => getApiAdminSocialFactionsByIdMembers({ ...clientOptions, signal, throwOnError: true }).then(response => response.data as TData) as TData, ...options });
/**
