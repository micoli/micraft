 ...
 */
export const getAuthMeOptions = (clientOptions: Options<GetAuthMeData, true> = {}, queryKey?: Array<unknown>) => queryOptions({ queryKey: Common.UseGetAuthMeKeyFn(clientOptions, queryKey), queryFn: ({ signal }) => getAuthMe({ ...clientOptions, signal, throwOnError: true }).then(response => response.data) });
/**
 * Redirect to the OAuth provider's consent screen
 */
export const getAuthOauthStartOptions = (clientOptions: Options<GetAuthOauthStartData, true> = {}, queryKey?: Array<unknown>) => queryOptions({ queryKey: Common.UseGetAuthOauthStartKeyFn(clientOptions, queryKey), queryFn: ({ signal }) => getAuthOauthStart({ ...clientOptions, signal, throwOnError: true }).then(response => response.data) });
/**
 * OAuth authorization code callback — redirects with the session token in the URL fragment
 */
export const getAuthCallbackOptions = (clientOptions: Options<GetAuthCallbackData, true> = {}, queryKey?: Array<unknown>) => queryOptions({ queryKey: Common.UseGetAuthCallbackKeyFn(clientOptions, queryKey), queryFn: ({ signal }) => getAuthCallback({ ...clientOptions, signal, throwOnError: true }).then(response => response.data) });
 ...
 */
export const getApiBiomesTintsOptions = (clientOptions: Options<GetApiBiomesTintsData, true> = {}, queryKey?: Array<unknown>) => queryOptions({ queryKey: Common.UseGetApiBiomesTintsKeyFn(clientOptions, queryKey), queryFn: ({ signal }) => getApiBiomesTints({ ...clientOptions, signal, throwOnError: true }).then(response => response.data) });
/**
 ...
 */
export const getApiVehiclesByNameConfigOptions = (clientOptions: Options<GetApiVehiclesByNameConfigData, true>, queryKey?: Array<unknown>) => queryOptions({ queryKey: Common.UseGetApiVehiclesByNameConfigKeyFn(clientOptions, queryKey), queryFn: ({ signal }) => getApiVehiclesByNameConfig({ ...clientOptions, signal, throwOnError: true }).then(response => response.data) });
/**
 ...
 */
export const getApiMinigamesOptions = (clientOptions: Options<GetApiMinigamesData, true> = {}, queryKey?: Array<unknown>) => queryOptions({ queryKey: Common.UseGetApiMinigamesKeyFn(clientOptions, queryKey), queryFn: ({ signal }) => getApiMinigames({ ...clientOptions, signal, throwOnError: true }).then(response => response.data) });
/**
 ...
 */
export const getApiSiegeWeaponsOptions = (clientOptions: Options<GetApiSiegeWeaponsData, true> = {}, queryKey?: Array<unknown>) => queryOptions({ queryKey: Common.UseGetApiSiegeWeaponsKeyFn(clientOptions, queryKey), queryFn: ({ signal }) => getApiSiegeWeapons({ ...clientOptions, signal, throwOnError: true }).then(response => response.data) });
/**
 * List all furniture definitions
 */
export const getApiFurnituresOptions = (clientOptions: Options<GetApiFurnituresData, true> = {}, queryKey?: Array<unknown>) => queryOptions({ queryKey: Common.UseGetApiFurnituresKeyFn(clientOptions, queryKey), queryFn: ({ signal }) => getApiFurnitures({ ...clientOptions, signal, throwOnError: true }).then(response => response.data) });
/**
 * List all auction listings, any status
 */
export const getApiAdminAuctionsOptions = (clientOptions: Options<GetApiAdminAuctionsData, true> = {}, queryKey?: Array<unknown>) => queryOptions({ queryKey: Common.UseGetApiAdminAuctionsKeyFn(clientOptions, queryKey), queryFn: ({ signal }) => getApiAdminAuctions({ ...clientOptions, signal, throwOnError: true }).then(response => response.data) });
/**
 ...
 */
export const getApiAdminPermissionsOptions = (clientOptions: Options<GetApiAdminPermissionsData, true> = {}, queryKey?: Array<unknown>) => queryOptions({ queryKey: Common.UseGetApiAdminPermissionsKeyFn(clientOptions, queryKey), queryFn: ({ signal }) => getApiAdminPermissions({ ...clientOptions, signal, throwOnError: true }).then(response => response.data) });
/**
 * All permission groups, including the virtual admin group
 */
export const getApiAdminGroupsOptions = (clientOptions: Options<GetApiAdminGroupsData, true> = {}, queryKey?: Array<unknown>) => queryOptions({ queryKey: Common.UseGetApiAdminGroupsKeyFn(clientOptions, queryKey), queryFn: ({ signal }) => getApiAdminGroups({ ...clientOptions, signal, throwOnError: true }).then(response => response.data) });
/**
 * All player names
 */
 ...
 */
export const getApiAdminPlayersByNameGroupsOptions = (clientOptions: Options<GetApiAdminPlayersByNameGroupsData, true>, queryKey?: Array<unknown>) => queryOptions({ queryKey: Common.UseGetApiAdminPlayersByNameGroupsKeyFn(clientOptions, queryKey), queryFn: ({ signal }) => getApiAdminPlayersByNameGroups({ ...clientOptions, signal, throwOnError: true }).then(response => response.data) });
/**
 ...
 */
export const getApiAdminLoggersOptions = (clientOptions: Options<GetApiAdminLoggersData, true> = {}, queryKey?: Array<unknown>) => queryOptions({ queryKey: Common.UseGetApiAdminLoggersKeyFn(clientOptions, queryKey), queryFn: ({ signal }) => getApiAdminLoggers({ ...clientOptions, signal, throwOnError: true }).then(response => response.data) });
/**
 ...
 * All land claims
 */
export const getApiAdminClaimsOptions = (clientOptions: Options<GetApiAdminClaimsData, true> = {}, queryKey?: Array<unknown>) => queryOptions({ queryKey: Common.UseGetApiAdminClaimsKeyFn(clientOptions, queryKey), queryFn: ({ signal }) => getApiAdminClaims({ ...clientOptions, signal, throwOnError: true }).then(response => response.data) });
/**
 * A single land claim
 */
export const getApiAdminClaimsByIdOptions = (clientOptions: Options<GetApiAdminClaimsByIdData, true>, queryKey?: Array<unknown>) => queryOptions({ queryKey: Common.UseGetApiAdminClaimsByIdKeyFn(clientOptions, queryKey), queryFn: ({ signal }) => getApiAdminClaimsById({ ...clientOptions, signal, throwOnError: true }).then(response => response.data) });
/**
 ...
 */
export const getApiAdminSocialOnlinePlayersOptions = (clientOptions: Options<GetApiAdminSocialOnlinePlayersData, true> = {}, queryKey?: Array<unknown>) => queryOptions({ queryKey: Common.UseGetApiAdminSocialOnlinePlayersKeyFn(clientOptions, queryKey), queryFn: ({ signal }) => getApiAdminSocialOnlinePlayers({ ...clientOptions, signal, throwOnError: true }).then(response => response.data) });
/**
 * Canonical display names of every known player (online + persisted), de-duplicated — for social name-field autocomplete
 */
export const getApiAdminSocialPlayersOptions = (clientOptions: Options<GetApiAdminSocialPlayersData, true> = {}, queryKey?: Array<unknown>) => queryOptions({ queryKey: Common.UseGetApiAdminSocialPlayersKeyFn(clientOptions, queryKey), queryFn: ({ signal }) => getApiAdminSocialPlayers({ ...clientOptions, signal, throwOnError: true }).then(response => response.data) });
/**
 * All active player groups
 */
export const getApiAdminSocialGroupsOptions = (clientOptions: Options<GetApiAdminSocialGroupsData, true> = {}, queryKey?: Array<unknown>) => queryOptions({ queryKey: Common.UseGetApiAdminSocialGroupsKeyFn(clientOptions, queryKey), queryFn: ({ signal }) => getApiAdminSocialGroups({ ...clientOptions, signal, throwOnError: true }).then(response => response.data) });
/**
 * All guilds
 */
export const getApiAdminSocialGuildsOptions = (clientOptions: Options<GetApiAdminSocialGuildsData, true> = {}, queryKey?: Array<unknown>) => queryOptions({ queryKey: Common.UseGetApiAdminSocialGuildsKeyFn(clientOptions, queryKey), queryFn: ({ signal }) => getApiAdminSocialGuilds({ ...clientOptions, signal, throwOnError: true }).then(response => response.data) });
/**
 * Faction settings and definitions
 */
export const getApiAdminSocialFactionsOptions = (clientOptions: Options<GetApiAdminSocialFactionsData, true> = {}, queryKey?: Array<unknown>) => queryOptions({ queryKey: Common.UseGetApiAdminSocialFactionsKeyFn(clientOptions, queryKey), queryFn: ({ signal }) => getApiAdminSocialFactions({ ...clientOptions, signal, throwOnError: true }).then(response => response.data) });
/**
 * Players affiliated with a faction (online + persisted)
 */
export const getApiAdminSocialFactionsByIdMembersOptions = (clientOptions: Options<GetApiAdminSocialFactionsByIdMembersData, true>, queryKey?: Array<unknown>) => queryOptions({ queryKey: Common.UseGetApiAdminSocialFactionsByIdMembersKeyFn(clientOptions, queryKey), queryFn: ({ signal }) => getApiAdminSocialFactionsByIdMembers({ ...clientOptions, signal, throwOnError: true }).then(response => response.data) });
/**
