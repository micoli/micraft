 ...
 */
export const ensureUseGetAuthMeData = (queryClient: QueryClient, clientOptions: Options<GetAuthMeData, true> = {}, options?: Omit<EnsureQueryDataOptions<Common.GetAuthMeDefaultResponse>, "queryKey" | "queryFn">) => queryClient.ensureQueryData({ queryKey: Common.UseGetAuthMeKeyFn(clientOptions), queryFn: ({ signal }) => getAuthMe({ ...clientOptions, signal, throwOnError: true }).then(response => response.data), ...options });
/**
 * Redirect to the OAuth provider's consent screen
 */
export const ensureUseGetAuthOauthStartData = (queryClient: QueryClient, clientOptions: Options<GetAuthOauthStartData, true> = {}, options?: Omit<EnsureQueryDataOptions<Common.GetAuthOauthStartDefaultResponse>, "queryKey" | "queryFn">) => queryClient.ensureQueryData({ queryKey: Common.UseGetAuthOauthStartKeyFn(clientOptions), queryFn: ({ signal }) => getAuthOauthStart({ ...clientOptions, signal, throwOnError: true }).then(response => response.data), ...options });
/**
 * OAuth authorization code callback — redirects with the session token in the URL fragment
 */
export const ensureUseGetAuthCallbackData = (queryClient: QueryClient, clientOptions: Options<GetAuthCallbackData, true> = {}, options?: Omit<EnsureQueryDataOptions<Common.GetAuthCallbackDefaultResponse>, "queryKey" | "queryFn">) => queryClient.ensureQueryData({ queryKey: Common.UseGetAuthCallbackKeyFn(clientOptions), queryFn: ({ signal }) => getAuthCallback({ ...clientOptions, signal, throwOnError: true }).then(response => response.data), ...options });
 ...
 */
export const ensureUseGetApiBiomesTintsData = (queryClient: QueryClient, clientOptions: Options<GetApiBiomesTintsData, true> = {}, options?: Omit<EnsureQueryDataOptions<Common.GetApiBiomesTintsDefaultResponse>, "queryKey" | "queryFn">) => queryClient.ensureQueryData({ queryKey: Common.UseGetApiBiomesTintsKeyFn(clientOptions), queryFn: ({ signal }) => getApiBiomesTints({ ...clientOptions, signal, throwOnError: true }).then(response => response.data), ...options });
/**
 ...
 */
export const ensureUseGetApiVehiclesByNameConfigData = (queryClient: QueryClient, clientOptions: Options<GetApiVehiclesByNameConfigData, true>, options?: Omit<EnsureQueryDataOptions<Common.GetApiVehiclesByNameConfigDefaultResponse>, "queryKey" | "queryFn">) => queryClient.ensureQueryData({ queryKey: Common.UseGetApiVehiclesByNameConfigKeyFn(clientOptions), queryFn: ({ signal }) => getApiVehiclesByNameConfig({ ...clientOptions, signal, throwOnError: true }).then(response => response.data), ...options });
/**
 ...
 */
export const ensureUseGetApiMinigamesData = (queryClient: QueryClient, clientOptions: Options<GetApiMinigamesData, true> = {}, options?: Omit<EnsureQueryDataOptions<Common.GetApiMinigamesDefaultResponse>, "queryKey" | "queryFn">) => queryClient.ensureQueryData({ queryKey: Common.UseGetApiMinigamesKeyFn(clientOptions), queryFn: ({ signal }) => getApiMinigames({ ...clientOptions, signal, throwOnError: true }).then(response => response.data), ...options });
/**
 ...
 */
export const ensureUseGetApiSiegeWeaponsData = (queryClient: QueryClient, clientOptions: Options<GetApiSiegeWeaponsData, true> = {}, options?: Omit<EnsureQueryDataOptions<Common.GetApiSiegeWeaponsDefaultResponse>, "queryKey" | "queryFn">) => queryClient.ensureQueryData({ queryKey: Common.UseGetApiSiegeWeaponsKeyFn(clientOptions), queryFn: ({ signal }) => getApiSiegeWeapons({ ...clientOptions, signal, throwOnError: true }).then(response => response.data), ...options });
/**
 * List all furniture definitions
 */
export const ensureUseGetApiFurnituresData = (queryClient: QueryClient, clientOptions: Options<GetApiFurnituresData, true> = {}, options?: Omit<EnsureQueryDataOptions<Common.GetApiFurnituresDefaultResponse>, "queryKey" | "queryFn">) => queryClient.ensureQueryData({ queryKey: Common.UseGetApiFurnituresKeyFn(clientOptions), queryFn: ({ signal }) => getApiFurnitures({ ...clientOptions, signal, throwOnError: true }).then(response => response.data), ...options });
/**
 * List all auction listings, any status
 */
export const ensureUseGetApiAdminAuctionsData = (queryClient: QueryClient, clientOptions: Options<GetApiAdminAuctionsData, true> = {}, options?: Omit<EnsureQueryDataOptions<Common.GetApiAdminAuctionsDefaultResponse>, "queryKey" | "queryFn">) => queryClient.ensureQueryData({ queryKey: Common.UseGetApiAdminAuctionsKeyFn(clientOptions), queryFn: ({ signal }) => getApiAdminAuctions({ ...clientOptions, signal, throwOnError: true }).then(response => response.data), ...options });
/**
 ...
 */
export const ensureUseGetApiAdminPermissionsData = (queryClient: QueryClient, clientOptions: Options<GetApiAdminPermissionsData, true> = {}, options?: Omit<EnsureQueryDataOptions<Common.GetApiAdminPermissionsDefaultResponse>, "queryKey" | "queryFn">) => queryClient.ensureQueryData({ queryKey: Common.UseGetApiAdminPermissionsKeyFn(clientOptions), queryFn: ({ signal }) => getApiAdminPermissions({ ...clientOptions, signal, throwOnError: true }).then(response => response.data), ...options });
/**
 * All permission groups, including the virtual admin group
 */
export const ensureUseGetApiAdminGroupsData = (queryClient: QueryClient, clientOptions: Options<GetApiAdminGroupsData, true> = {}, options?: Omit<EnsureQueryDataOptions<Common.GetApiAdminGroupsDefaultResponse>, "queryKey" | "queryFn">) => queryClient.ensureQueryData({ queryKey: Common.UseGetApiAdminGroupsKeyFn(clientOptions), queryFn: ({ signal }) => getApiAdminGroups({ ...clientOptions, signal, throwOnError: true }).then(response => response.data), ...options });
/**
 * All player names
 */
 ...
 */
export const ensureUseGetApiAdminPlayersByNameGroupsData = (queryClient: QueryClient, clientOptions: Options<GetApiAdminPlayersByNameGroupsData, true>, options?: Omit<EnsureQueryDataOptions<Common.GetApiAdminPlayersByNameGroupsDefaultResponse>, "queryKey" | "queryFn">) => queryClient.ensureQueryData({ queryKey: Common.UseGetApiAdminPlayersByNameGroupsKeyFn(clientOptions), queryFn: ({ signal }) => getApiAdminPlayersByNameGroups({ ...clientOptions, signal, throwOnError: true }).then(response => response.data), ...options });
/**
 ...
 */
export const ensureUseGetApiAdminLoggersData = (queryClient: QueryClient, clientOptions: Options<GetApiAdminLoggersData, true> = {}, options?: Omit<EnsureQueryDataOptions<Common.GetApiAdminLoggersDefaultResponse>, "queryKey" | "queryFn">) => queryClient.ensureQueryData({ queryKey: Common.UseGetApiAdminLoggersKeyFn(clientOptions), queryFn: ({ signal }) => getApiAdminLoggers({ ...clientOptions, signal, throwOnError: true }).then(response => response.data), ...options });
/**
 ...
 * All land claims
 */
export const ensureUseGetApiAdminClaimsData = (queryClient: QueryClient, clientOptions: Options<GetApiAdminClaimsData, true> = {}, options?: Omit<EnsureQueryDataOptions<Common.GetApiAdminClaimsDefaultResponse>, "queryKey" | "queryFn">) => queryClient.ensureQueryData({ queryKey: Common.UseGetApiAdminClaimsKeyFn(clientOptions), queryFn: ({ signal }) => getApiAdminClaims({ ...clientOptions, signal, throwOnError: true }).then(response => response.data), ...options });
/**
 * A single land claim
 */
export const ensureUseGetApiAdminClaimsByIdData = (queryClient: QueryClient, clientOptions: Options<GetApiAdminClaimsByIdData, true>, options?: Omit<EnsureQueryDataOptions<Common.GetApiAdminClaimsByIdDefaultResponse>, "queryKey" | "queryFn">) => queryClient.ensureQueryData({ queryKey: Common.UseGetApiAdminClaimsByIdKeyFn(clientOptions), queryFn: ({ signal }) => getApiAdminClaimsById({ ...clientOptions, signal, throwOnError: true }).then(response => response.data), ...options });
/**
 ...
 */
export const ensureUseGetApiAdminSocialOnlinePlayersData = (queryClient: QueryClient, clientOptions: Options<GetApiAdminSocialOnlinePlayersData, true> = {}, options?: Omit<EnsureQueryDataOptions<Common.GetApiAdminSocialOnlinePlayersDefaultResponse>, "queryKey" | "queryFn">) => queryClient.ensureQueryData({ queryKey: Common.UseGetApiAdminSocialOnlinePlayersKeyFn(clientOptions), queryFn: ({ signal }) => getApiAdminSocialOnlinePlayers({ ...clientOptions, signal, throwOnError: true }).then(response => response.data), ...options });
/**
 * Canonical display names of every known player (online + persisted), de-duplicated — for social name-field autocomplete
 */
export const ensureUseGetApiAdminSocialPlayersData = (queryClient: QueryClient, clientOptions: Options<GetApiAdminSocialPlayersData, true> = {}, options?: Omit<EnsureQueryDataOptions<Common.GetApiAdminSocialPlayersDefaultResponse>, "queryKey" | "queryFn">) => queryClient.ensureQueryData({ queryKey: Common.UseGetApiAdminSocialPlayersKeyFn(clientOptions), queryFn: ({ signal }) => getApiAdminSocialPlayers({ ...clientOptions, signal, throwOnError: true }).then(response => response.data), ...options });
/**
 * All active player groups
 */
export const ensureUseGetApiAdminSocialGroupsData = (queryClient: QueryClient, clientOptions: Options<GetApiAdminSocialGroupsData, true> = {}, options?: Omit<EnsureQueryDataOptions<Common.GetApiAdminSocialGroupsDefaultResponse>, "queryKey" | "queryFn">) => queryClient.ensureQueryData({ queryKey: Common.UseGetApiAdminSocialGroupsKeyFn(clientOptions), queryFn: ({ signal }) => getApiAdminSocialGroups({ ...clientOptions, signal, throwOnError: true }).then(response => response.data), ...options });
/**
 * All guilds
 */
export const ensureUseGetApiAdminSocialGuildsData = (queryClient: QueryClient, clientOptions: Options<GetApiAdminSocialGuildsData, true> = {}, options?: Omit<EnsureQueryDataOptions<Common.GetApiAdminSocialGuildsDefaultResponse>, "queryKey" | "queryFn">) => queryClient.ensureQueryData({ queryKey: Common.UseGetApiAdminSocialGuildsKeyFn(clientOptions), queryFn: ({ signal }) => getApiAdminSocialGuilds({ ...clientOptions, signal, throwOnError: true }).then(response => response.data), ...options });
/**
 * Faction settings and definitions
 */
export const ensureUseGetApiAdminSocialFactionsData = (queryClient: QueryClient, clientOptions: Options<GetApiAdminSocialFactionsData, true> = {}, options?: Omit<EnsureQueryDataOptions<Common.GetApiAdminSocialFactionsDefaultResponse>, "queryKey" | "queryFn">) => queryClient.ensureQueryData({ queryKey: Common.UseGetApiAdminSocialFactionsKeyFn(clientOptions), queryFn: ({ signal }) => getApiAdminSocialFactions({ ...clientOptions, signal, throwOnError: true }).then(response => response.data), ...options });
/**
 * Players affiliated with a faction (online + persisted)
 */
export const ensureUseGetApiAdminSocialFactionsByIdMembersData = (queryClient: QueryClient, clientOptions: Options<GetApiAdminSocialFactionsByIdMembersData, true>, options?: Omit<EnsureQueryDataOptions<Common.GetApiAdminSocialFactionsByIdMembersDefaultResponse>, "queryKey" | "queryFn">) => queryClient.ensureQueryData({ queryKey: Common.UseGetApiAdminSocialFactionsByIdMembersKeyFn(clientOptions), queryFn: ({ signal }) => getApiAdminSocialFactionsByIdMembers({ ...clientOptions, signal, throwOnError: true }).then(response => response.data), ...options });
/**
