 ...
 */
export const prefetchUseGetAuthMe = (queryClient: QueryClient, clientOptions: Options<GetAuthMeData, true> = {}, options?: Omit<FetchQueryOptions<Common.GetAuthMeDefaultResponse>, "queryKey" | "queryFn">) => queryClient.prefetchQuery({ queryKey: Common.UseGetAuthMeKeyFn(clientOptions), queryFn: ({ signal }) => getAuthMe({ ...clientOptions, signal, throwOnError: true }).then(response => response.data), ...options });
/**
 * Redirect to the OAuth provider's consent screen
 */
export const prefetchUseGetAuthOauthStart = (queryClient: QueryClient, clientOptions: Options<GetAuthOauthStartData, true> = {}, options?: Omit<FetchQueryOptions<Common.GetAuthOauthStartDefaultResponse>, "queryKey" | "queryFn">) => queryClient.prefetchQuery({ queryKey: Common.UseGetAuthOauthStartKeyFn(clientOptions), queryFn: ({ signal }) => getAuthOauthStart({ ...clientOptions, signal, throwOnError: true }).then(response => response.data), ...options });
/**
 * OAuth authorization code callback — redirects with the session token in the URL fragment
 */
export const prefetchUseGetAuthCallback = (queryClient: QueryClient, clientOptions: Options<GetAuthCallbackData, true> = {}, options?: Omit<FetchQueryOptions<Common.GetAuthCallbackDefaultResponse>, "queryKey" | "queryFn">) => queryClient.prefetchQuery({ queryKey: Common.UseGetAuthCallbackKeyFn(clientOptions), queryFn: ({ signal }) => getAuthCallback({ ...clientOptions, signal, throwOnError: true }).then(response => response.data), ...options });
 ...
 */
export const prefetchUseGetApiBiomesTints = (queryClient: QueryClient, clientOptions: Options<GetApiBiomesTintsData, true> = {}, options?: Omit<FetchQueryOptions<Common.GetApiBiomesTintsDefaultResponse>, "queryKey" | "queryFn">) => queryClient.prefetchQuery({ queryKey: Common.UseGetApiBiomesTintsKeyFn(clientOptions), queryFn: ({ signal }) => getApiBiomesTints({ ...clientOptions, signal, throwOnError: true }).then(response => response.data), ...options });
/**
 ...
 */
export const prefetchUseGetApiPlayerByIdHands = (queryClient: QueryClient, clientOptions: Options<GetApiPlayerByIdHandsData, true>, options?: Omit<FetchQueryOptions<Common.GetApiPlayerByIdHandsDefaultResponse>, "queryKey" | "queryFn">) => queryClient.prefetchQuery({ queryKey: Common.UseGetApiPlayerByIdHandsKeyFn(clientOptions), queryFn: ({ signal }) => getApiPlayerByIdHands({ ...clientOptions, signal, throwOnError: true }).then(response => response.data), ...options });
/**
 * Armor/weapon/tool names owned by a player
 */
export const prefetchUseGetApiPlayerByIdOwned = (queryClient: QueryClient, clientOptions: Options<GetApiPlayerByIdOwnedData, true>, options?: Omit<FetchQueryOptions<Common.GetApiPlayerByIdOwnedDefaultResponse>, "queryKey" | "queryFn">) => queryClient.prefetchQuery({ queryKey: Common.UseGetApiPlayerByIdOwnedKeyFn(clientOptions), queryFn: ({ signal }) => getApiPlayerByIdOwned({ ...clientOptions, signal, throwOnError: true }).then(response => response.data), ...options });
/**
 ...
 */
export const prefetchUseGetApiVehiclesByNameConfig = (queryClient: QueryClient, clientOptions: Options<GetApiVehiclesByNameConfigData, true>, options?: Omit<FetchQueryOptions<Common.GetApiVehiclesByNameConfigDefaultResponse>, "queryKey" | "queryFn">) => queryClient.prefetchQuery({ queryKey: Common.UseGetApiVehiclesByNameConfigKeyFn(clientOptions), queryFn: ({ signal }) => getApiVehiclesByNameConfig({ ...clientOptions, signal, throwOnError: true }).then(response => response.data), ...options });
/**
 ...
 */
export const prefetchUseGetApiMinigames = (queryClient: QueryClient, clientOptions: Options<GetApiMinigamesData, true> = {}, options?: Omit<FetchQueryOptions<Common.GetApiMinigamesDefaultResponse>, "queryKey" | "queryFn">) => queryClient.prefetchQuery({ queryKey: Common.UseGetApiMinigamesKeyFn(clientOptions), queryFn: ({ signal }) => getApiMinigames({ ...clientOptions, signal, throwOnError: true }).then(response => response.data), ...options });
/**
 * List all weapon definitions
 */
export const prefetchUseGetApiWeapons = (queryClient: QueryClient, clientOptions: Options<GetApiWeaponsData, true> = {}, options?: Omit<FetchQueryOptions<Common.GetApiWeaponsDefaultResponse>, "queryKey" | "queryFn">) => queryClient.prefetchQuery({ queryKey: Common.UseGetApiWeaponsKeyFn(clientOptions), queryFn: ({ signal }) => getApiWeapons({ ...clientOptions, signal, throwOnError: true }).then(response => response.data), ...options });
/**
 * List all tool definitions
 */
export const prefetchUseGetApiTools = (queryClient: QueryClient, clientOptions: Options<GetApiToolsData, true> = {}, options?: Omit<FetchQueryOptions<Common.GetApiToolsDefaultResponse>, "queryKey" | "queryFn">) => queryClient.prefetchQuery({ queryKey: Common.UseGetApiToolsKeyFn(clientOptions), queryFn: ({ signal }) => getApiTools({ ...clientOptions, signal, throwOnError: true }).then(response => response.data), ...options });
/**
 * List all siege weapon definitions
 */
export const prefetchUseGetApiSiegeWeapons = (queryClient: QueryClient, clientOptions: Options<GetApiSiegeWeaponsData, true> = {}, options?: Omit<FetchQueryOptions<Common.GetApiSiegeWeaponsDefaultResponse>, "queryKey" | "queryFn">) => queryClient.prefetchQuery({ queryKey: Common.UseGetApiSiegeWeaponsKeyFn(clientOptions), queryFn: ({ signal }) => getApiSiegeWeapons({ ...clientOptions, signal, throwOnError: true }).then(response => response.data), ...options });
/**
 * List all furniture definitions
 */
export const prefetchUseGetApiFurnitures = (queryClient: QueryClient, clientOptions: Options<GetApiFurnituresData, true> = {}, options?: Omit<FetchQueryOptions<Common.GetApiFurnituresDefaultResponse>, "queryKey" | "queryFn">) => queryClient.prefetchQuery({ queryKey: Common.UseGetApiFurnituresKeyFn(clientOptions), queryFn: ({ signal }) => getApiFurnitures({ ...clientOptions, signal, throwOnError: true }).then(response => response.data), ...options });
/**
 * List all auction listings, any status
 */
export const prefetchUseGetApiAdminAuctions = (queryClient: QueryClient, clientOptions: Options<GetApiAdminAuctionsData, true> = {}, options?: Omit<FetchQueryOptions<Common.GetApiAdminAuctionsDefaultResponse>, "queryKey" | "queryFn">) => queryClient.prefetchQuery({ queryKey: Common.UseGetApiAdminAuctionsKeyFn(clientOptions), queryFn: ({ signal }) => getApiAdminAuctions({ ...clientOptions, signal, throwOnError: true }).then(response => response.data), ...options });
/**
 ...
 */
export const prefetchUseGetApiGameAssetsBlendSceneBy = (queryClient: QueryClient, clientOptions: Options<GetApiGameAssetsBlendSceneByData, true>, options?: Omit<FetchQueryOptions<Common.GetApiGameAssetsBlendSceneByDefaultResponse>, "queryKey" | "queryFn">) => queryClient.prefetchQuery({ queryKey: Common.UseGetApiGameAssetsBlendSceneByKeyFn(clientOptions), queryFn: ({ signal }) => getApiGameAssetsBlendSceneBy({ ...clientOptions, signal, throwOnError: true }).then(response => response.data), ...options });
/**
 * Converts a .blend file to OBJ/MTL via headless Blender (cached) and returns the OBJ asset path
 */
export const prefetchUseGetApiGameAssetsBlendPreviewBy = (queryClient: QueryClient, clientOptions: Options<GetApiGameAssetsBlendPreviewByData, true>, options?: Omit<FetchQueryOptions<Common.GetApiGameAssetsBlendPreviewByDefaultResponse>, "queryKey" | "queryFn">) => queryClient.prefetchQuery({ queryKey: Common.UseGetApiGameAssetsBlendPreviewByKeyFn(clientOptions), queryFn: ({ signal }) => getApiGameAssetsBlendPreviewBy({ ...clientOptions, signal, throwOnError: true }).then(response => response.data), ...options });
/**
 ...
 */
export const prefetchUseGetApiGameAssetsBbmodelExportBy = (queryClient: QueryClient, clientOptions: Options<GetApiGameAssetsBbmodelExportByData, true>, options?: Omit<FetchQueryOptions<Common.GetApiGameAssetsBbmodelExportByDefaultResponse>, "queryKey" | "queryFn">) => queryClient.prefetchQuery({ queryKey: Common.UseGetApiGameAssetsBbmodelExportByKeyFn(clientOptions), queryFn: ({ signal }) => getApiGameAssetsBbmodelExportBy({ ...clientOptions, signal, throwOnError: true }).then(response => response.data), ...options });
/**
 ...
 */
export const prefetchUseGetApiAdminPermissions = (queryClient: QueryClient, clientOptions: Options<GetApiAdminPermissionsData, true> = {}, options?: Omit<FetchQueryOptions<Common.GetApiAdminPermissionsDefaultResponse>, "queryKey" | "queryFn">) => queryClient.prefetchQuery({ queryKey: Common.UseGetApiAdminPermissionsKeyFn(clientOptions), queryFn: ({ signal }) => getApiAdminPermissions({ ...clientOptions, signal, throwOnError: true }).then(response => response.data), ...options });
/**
 * All permission groups, including the virtual admin group
 */
export const prefetchUseGetApiAdminGroups = (queryClient: QueryClient, clientOptions: Options<GetApiAdminGroupsData, true> = {}, options?: Omit<FetchQueryOptions<Common.GetApiAdminGroupsDefaultResponse>, "queryKey" | "queryFn">) => queryClient.prefetchQuery({ queryKey: Common.UseGetApiAdminGroupsKeyFn(clientOptions), queryFn: ({ signal }) => getApiAdminGroups({ ...clientOptions, signal, throwOnError: true }).then(response => response.data), ...options });
/**
 * All player names
 */
 ...
 */
export const prefetchUseGetApiAdminPlayersByNameGroups = (queryClient: QueryClient, clientOptions: Options<GetApiAdminPlayersByNameGroupsData, true>, options?: Omit<FetchQueryOptions<Common.GetApiAdminPlayersByNameGroupsDefaultResponse>, "queryKey" | "queryFn">) => queryClient.prefetchQuery({ queryKey: Common.UseGetApiAdminPlayersByNameGroupsKeyFn(clientOptions), queryFn: ({ signal }) => getApiAdminPlayersByNameGroups({ ...clientOptions, signal, throwOnError: true }).then(response => response.data), ...options });
/**
 ...
 */
export const prefetchUseGetApiAdminLoggers = (queryClient: QueryClient, clientOptions: Options<GetApiAdminLoggersData, true> = {}, options?: Omit<FetchQueryOptions<Common.GetApiAdminLoggersDefaultResponse>, "queryKey" | "queryFn">) => queryClient.prefetchQuery({ queryKey: Common.UseGetApiAdminLoggersKeyFn(clientOptions), queryFn: ({ signal }) => getApiAdminLoggers({ ...clientOptions, signal, throwOnError: true }).then(response => response.data), ...options });
/**
 ...
 * All land claims
 */
export const prefetchUseGetApiAdminClaims = (queryClient: QueryClient, clientOptions: Options<GetApiAdminClaimsData, true> = {}, options?: Omit<FetchQueryOptions<Common.GetApiAdminClaimsDefaultResponse>, "queryKey" | "queryFn">) => queryClient.prefetchQuery({ queryKey: Common.UseGetApiAdminClaimsKeyFn(clientOptions), queryFn: ({ signal }) => getApiAdminClaims({ ...clientOptions, signal, throwOnError: true }).then(response => response.data), ...options });
/**
 * A single land claim
 */
export const prefetchUseGetApiAdminClaimsById = (queryClient: QueryClient, clientOptions: Options<GetApiAdminClaimsByIdData, true>, options?: Omit<FetchQueryOptions<Common.GetApiAdminClaimsByIdDefaultResponse>, "queryKey" | "queryFn">) => queryClient.prefetchQuery({ queryKey: Common.UseGetApiAdminClaimsByIdKeyFn(clientOptions), queryFn: ({ signal }) => getApiAdminClaimsById({ ...clientOptions, signal, throwOnError: true }).then(response => response.data), ...options });
/**
 ...
 */
export const prefetchUseGetApiAdminScenesByIdEntities = (queryClient: QueryClient, clientOptions: Options<GetApiAdminScenesByIdEntitiesData, true>, options?: Omit<FetchQueryOptions<Common.GetApiAdminScenesByIdEntitiesDefaultResponse>, "queryKey" | "queryFn">) => queryClient.prefetchQuery({ queryKey: Common.UseGetApiAdminScenesByIdEntitiesKeyFn(clientOptions), queryFn: ({ signal }) => getApiAdminScenesByIdEntities({ ...clientOptions, signal, throwOnError: true }).then(response => response.data), ...options });
/**
 * Names of currently connected players (group-member autocomplete)
 */
export const prefetchUseGetApiAdminSocialOnlinePlayers = (queryClient: QueryClient, clientOptions: Options<GetApiAdminSocialOnlinePlayersData, true> = {}, options?: Omit<FetchQueryOptions<Common.GetApiAdminSocialOnlinePlayersDefaultResponse>, "queryKey" | "queryFn">) => queryClient.prefetchQuery({ queryKey: Common.UseGetApiAdminSocialOnlinePlayersKeyFn(clientOptions), queryFn: ({ signal }) => getApiAdminSocialOnlinePlayers({ ...clientOptions, signal, throwOnError: true }).then(response => response.data), ...options });
/**
 * Canonical display names of every known player (online + persisted), de-duplicated — for social name-field autocomplete
 */
export const prefetchUseGetApiAdminSocialPlayers = (queryClient: QueryClient, clientOptions: Options<GetApiAdminSocialPlayersData, true> = {}, options?: Omit<FetchQueryOptions<Common.GetApiAdminSocialPlayersDefaultResponse>, "queryKey" | "queryFn">) => queryClient.prefetchQuery({ queryKey: Common.UseGetApiAdminSocialPlayersKeyFn(clientOptions), queryFn: ({ signal }) => getApiAdminSocialPlayers({ ...clientOptions, signal, throwOnError: true }).then(response => response.data), ...options });
/**
 * All active player groups
 */
export const prefetchUseGetApiAdminSocialGroups = (queryClient: QueryClient, clientOptions: Options<GetApiAdminSocialGroupsData, true> = {}, options?: Omit<FetchQueryOptions<Common.GetApiAdminSocialGroupsDefaultResponse>, "queryKey" | "queryFn">) => queryClient.prefetchQuery({ queryKey: Common.UseGetApiAdminSocialGroupsKeyFn(clientOptions), queryFn: ({ signal }) => getApiAdminSocialGroups({ ...clientOptions, signal, throwOnError: true }).then(response => response.data), ...options });
/**
 * All guilds
 */
export const prefetchUseGetApiAdminSocialGuilds = (queryClient: QueryClient, clientOptions: Options<GetApiAdminSocialGuildsData, true> = {}, options?: Omit<FetchQueryOptions<Common.GetApiAdminSocialGuildsDefaultResponse>, "queryKey" | "queryFn">) => queryClient.prefetchQuery({ queryKey: Common.UseGetApiAdminSocialGuildsKeyFn(clientOptions), queryFn: ({ signal }) => getApiAdminSocialGuilds({ ...clientOptions, signal, throwOnError: true }).then(response => response.data), ...options });
/**
 * Faction settings and definitions
 */
export const prefetchUseGetApiAdminSocialFactions = (queryClient: QueryClient, clientOptions: Options<GetApiAdminSocialFactionsData, true> = {}, options?: Omit<FetchQueryOptions<Common.GetApiAdminSocialFactionsDefaultResponse>, "queryKey" | "queryFn">) => queryClient.prefetchQuery({ queryKey: Common.UseGetApiAdminSocialFactionsKeyFn(clientOptions), queryFn: ({ signal }) => getApiAdminSocialFactions({ ...clientOptions, signal, throwOnError: true }).then(response => response.data), ...options });
/**
 * Players affiliated with a faction (online + persisted)
 */
export const prefetchUseGetApiAdminSocialFactionsByIdMembers = (queryClient: QueryClient, clientOptions: Options<GetApiAdminSocialFactionsByIdMembersData, true>, options?: Omit<FetchQueryOptions<Common.GetApiAdminSocialFactionsByIdMembersDefaultResponse>, "queryKey" | "queryFn">) => queryClient.prefetchQuery({ queryKey: Common.UseGetApiAdminSocialFactionsByIdMembersKeyFn(clientOptions), queryFn: ({ signal }) => getApiAdminSocialFactionsByIdMembers({ ...clientOptions, signal, throwOnError: true }).then(response => response.data), ...options });
/**
