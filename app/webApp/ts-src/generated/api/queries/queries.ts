...
import { deleteApiAdminClaimsById, deleteApiAdminGroupsByName, deleteApiAdminInstancesById, deleteApiAdminScenesById, deleteApiAdminSocialFactionsById, deleteApiAdminSocialFactionsByIdMembersByPlayerId, deleteApiAdminSocialGroupsById, deleteApiAdminSocialGroupsByIdMembersByPlayerId, deleteApiAdminSocialGuildsById, deleteApiAdminSocialGuildsByIdMembersByPlayerId, deleteApiAdminUsersByEmail, deleteApiGameAssetsBlendCacheBy, getApiAdminAuctions, getApiAdminBlocks, getApiAdminChunksDiscovered, getApiAdminClaims, getApiAdminClaimsById, getApiAdminClasses, getApiAdminConfigs, getApiAdminConfigsBy, getApiAdminGroups, getApiAdminInstances, getApiAdminInstancesById, getApiAdminInstancesByIdBlocks, getApiAdminItems, getApiAdminLoggers, getApiAdminNpcTypes, getApiAdminNpcs, getApiAdminPermissions, getApiAdminPlainColors, getApiAdminPlayers, getApiAdminPlayersByName, getApiAdminPlayersByNameGroups, getApiAdminScenes, getApiAdminScenesById, getApiAdminScenesByIdBlocksRaw, getApiAdminScenesByIdEntities, getApiAdminSchemasByFilename, getApiAdminSimulationDefaults, getApiAdminSkills, getApiAdminSocialFactions, getApiAdminSocialFactionsByIdMembers, getApiAdminSocialGroups, getApiAdminSocialGuilds, getApiAdminSocialOnlinePlayers, getApiAdminSocialPlayers, getApiAdminStatus, getApiAdminUsers, getApiAdminWorlds, getApiAdminWsInstancesById, getApiAdminWsNpcs, getApiAdminWsScenesById, getApiAdminWsSimulation, getApiArmors, getApiAssetsManifest, getApiAttacks, getApiAuthConfig, getApiAutocompleteByCommandIdByArgIndex, getApiBiomes, getApiBiomesTints, getApiChunksByCxByCz, getApiClasses, getApiFurnitures, getApiGameAssets, getApiGameAssetsBbmodelExportBy, getApiGameAssetsBlendPreviewBy, getApiGameAssetsBlendSceneBy, getApiGameAssetsFileBy, getApiI18nByLocale, getApiItemsMeta, getApiKeybindings, getApiLayoutRegistry, getApiMacrosContext, getApiMapHouses, getApiMapRoadRaster, getApiMapRoadRasterPng, getApiMapRoads, getApiMapStaircases, getApiMapState, getApiMapTerrain, getApiMapTerrainRasterPng, getApiMapVoronoi, getApiMapVoronoiBorders, getApiMinigames, getApiPlayerByIdArmors, getApiPlayerByIdHands, getApiPlayerByIdOwned, getApiPlayerByIdRpg, getApiPlayerByIdSkin, getApiPlayersByEmailByEmail, getApiPlayersNames, getApiQuests, getApiServerInfo, getApiSiegeWeapons, getApiSkins, getApiSkinsByNameConfig, getApiSpells, getApiTools, getApiVehiclesByNameConfig, getApiWeapons, getAuthCallback, getAuthMe, getAuthOauthStart, postApiAdminAuctionsByIdForceCancel, postApiAdminGroups, postApiAdminInstances, postApiAdminNpcTypesReload, postApiAdminNpcsByIdChatTest, postApiAdminPlayers, postApiAdminPlayersByNameGive, postApiAdminPlayersByNameRename, postApiAdminReload, postApiAdminRestart, postApiAdminScenes, postApiAdminScenesByIdDuplicate, postApiAdminSocialFactions, postApiAdminSocialFactionsByIdMembers, postApiAdminSocialGroups, postApiAdminSocialGroupsByIdMembers, postApiAdminSocialGuilds, postApiAdminSocialGuildsByIdMembers, postApiAdminUsers, postApiAdminWorlds, postApiAssetsReload, postApiCharacterCreate, postApiCharacterRpgcreate, postApiPlayerByIdScreenshots, postAuthLogin, postAuthRefresh, putApiAdminClaimsByIdBounds, putApiAdminClaimsByIdTrust, putApiAdminConfigsBy, putApiAdminGametime, putApiAdminGroupsByName, putApiAdminInstancesById, putApiAdminInstancesByIdBounds, putApiAdminInstancesByIdChunks, putApiAdminInstancesByIdEnabled, putApiAdminInstancesByIdLayout, putApiAdminLoggersBy, putApiAdminPlayersByNameEquipment, putApiAdminPlayersByNameGroups, putApiAdminPlayersByNameKeybindings, putApiAdminPlayersByNamePreferences, putApiAdminPlayersByNameRpg, putApiAdminScenesById, putApiAdminScenesByIdDimensions, putApiAdminScenesByIdLayout, putApiAdminSocialFactionsSettings, putApiAdminSocialGuildsById, putApiAdminSocialGuildsByIdMembersByPlayerId, putApiAdminUsersByEmail, putApiPlayerByIdSkin, type Options } from "../requests/sdk.gen";
import type { DeleteApiAdminClaimsByIdData, DeleteApiAdminGroupsByNameData, DeleteApiAdminInstancesByIdData, DeleteApiAdminScenesByIdData, DeleteApiAdminSocialFactionsByIdData, DeleteApiAdminSocialFactionsByIdMembersByPlayerIdData, DeleteApiAdminSocialGroupsByIdData, DeleteApiAdminSocialGroupsByIdMembersByPlayerIdData, DeleteApiAdminSocialGuildsByIdData, DeleteApiAdminSocialGuildsByIdMembersByPlayerIdData, DeleteApiAdminUsersByEmailData, DeleteApiGameAssetsBlendCacheByData, GetApiAdminAuctionsData, GetApiAdminBlocksData, GetApiAdminChunksDiscoveredData, GetApiAdminClaimsByIdData, GetApiAdminClaimsData, GetApiAdminClassesData, GetApiAdminConfigsByData, GetApiAdminConfigsData, GetApiAdminGroupsData, GetApiAdminInstancesByIdBlocksData, GetApiAdminInstancesByIdData, GetApiAdminInstancesData, GetApiAdminItemsData, GetApiAdminLoggersData, GetApiAdminNpcTypesData, GetApiAdminNpcsData, GetApiAdminPermissionsData, GetApiAdminPlainColorsData, GetApiAdminPlayersByNameData, GetApiAdminPlayersByNameGroupsData, GetApiAdminPlayersData, GetApiAdminScenesByIdBlocksRawData, GetApiAdminScenesByIdData, GetApiAdminScenesByIdEntitiesData, GetApiAdminScenesData, GetApiAdminSchemasByFilenameData, GetApiAdminSimulationDefaultsData, GetApiAdminSkillsData, GetApiAdminSocialFactionsByIdMembersData, GetApiAdminSocialFactionsData, GetApiAdminSocialGroupsData, GetApiAdminSocialGuildsData, GetApiAdminSocialOnlinePlayersData, GetApiAdminSocialPlayersData, GetApiAdminStatusData, GetApiAdminUsersData, GetApiAdminWorldsData, GetApiAdminWsInstancesByIdData, GetApiAdminWsNpcsData, GetApiAdminWsScenesByIdData, GetApiAdminWsSimulationData, GetApiArmorsData, GetApiAssetsManifestData, GetApiAttacksData, GetApiAuthConfigData, GetApiAutocompleteByCommandIdByArgIndexData, GetApiBiomesData, GetApiBiomesTintsData, GetApiChunksByCxByCzData, GetApiClassesData, GetApiFurnituresData, GetApiGameAssetsBbmodelExportByData, GetApiGameAssetsBlendPreviewByData, GetApiGameAssetsBlendSceneByData, GetApiGameAssetsData, GetApiGameAssetsFileByData, GetApiI18nByLocaleData, GetApiItemsMetaData, GetApiKeybindingsData, GetApiLayoutRegistryData, GetApiMacrosContextData, GetApiMapHousesData, GetApiMapRoadRasterData, GetApiMapRoadRasterPngData, GetApiMapRoadsData, GetApiMapStaircasesData, GetApiMapStateData, GetApiMapTerrainData, GetApiMapTerrainRasterPngData, GetApiMapVoronoiBordersData, GetApiMapVoronoiData, GetApiMinigamesData, GetApiPlayerByIdArmorsData, GetApiPlayerByIdHandsData, GetApiPlayerByIdOwnedData, GetApiPlayerByIdRpgData, GetApiPlayerByIdSkinData, GetApiPlayersByEmailByEmailData, GetApiPlayersNamesData, GetApiQuestsData, GetApiServerInfoData, GetApiSiegeWeaponsData, GetApiSkinsByNameConfigData, GetApiSkinsData, GetApiSpellsData, GetApiToolsData, GetApiVehiclesByNameConfigData, GetApiWeaponsData, GetAuthCallbackData, GetAuthMeData, GetAuthOauthStartData, PostApiAdminAuctionsByIdForceCancelData, PostApiAdminGroupsData, PostApiAdminInstancesData, PostApiAdminNpcTypesReloadData, PostApiAdminNpcsByIdChatTestData, PostApiAdminPlayersByNameGiveData, PostApiAdminPlayersByNameRenameData, PostApiAdminPlayersData, PostApiAdminReloadData, PostApiAdminRestartData, PostApiAdminScenesByIdDuplicateData, PostApiAdminScenesData, PostApiAdminSocialFactionsByIdMembersData, PostApiAdminSocialFactionsData, PostApiAdminSocialGroupsByIdMembersData, PostApiAdminSocialGroupsData, PostApiAdminSocialGuildsByIdMembersData, PostApiAdminSocialGuildsData, PostApiAdminUsersData, PostApiAdminWorldsData, PostApiAssetsReloadData, PostApiCharacterCreateData, PostApiCharacterRpgcreateData, PostApiPlayerByIdScreenshotsData, PostAuthLoginData, PostAuthRefreshData, PutApiAdminClaimsByIdBoundsData, PutApiAdminClaimsByIdTrustData, PutApiAdminConfigsByData, PutApiAdminGametimeData, PutApiAdminGroupsByNameData, PutApiAdminInstancesByIdBoundsData, PutApiAdminInstancesByIdChunksData, PutApiAdminInstancesByIdData, PutApiAdminInstancesByIdEnabledData, PutApiAdminInstancesByIdLayoutData, PutApiAdminLoggersByData, PutApiAdminPlayersByNameEquipmentData, PutApiAdminPlayersByNameGroupsData, PutApiAdminPlayersByNameKeybindingsData, PutApiAdminPlayersByNamePreferencesData, PutApiAdminPlayersByNameRpgData, PutApiAdminScenesByIdData, PutApiAdminScenesByIdDimensionsData, PutApiAdminScenesByIdLayoutData, PutApiAdminSocialFactionsSettingsData, PutApiAdminSocialGuildsByIdData, PutApiAdminSocialGuildsByIdMembersByPlayerIdData, PutApiAdminUsersByEmailData, PutApiPlayerByIdSkinData } from "../requests/types.gen";
...
/**
 * Resolve the current session from its bearer token
 */
export const useGetAuthMe = <TData = Common.GetAuthMeDefaultResponse, TError = unknown, TQueryKey extends Array<unknown> = unknown[]>(clientOptions: Options<GetAuthMeData, true> = {}, queryKey?: TQueryKey, options?: Omit<UseQueryOptions<TData, TError>, "queryKey" | "queryFn">) => useQuery<TData, TError>({ queryKey: Common.UseGetAuthMeKeyFn(clientOptions, queryKey), queryFn: ({ signal }) => getAuthMe({ ...clientOptions, signal, throwOnError: true }).then(response => response.data as TData) as TData, ...options });
/**
 * Redirect to the OAuth provider's consent screen
 */
export const useGetAuthOauthStart = <TData = Common.GetAuthOauthStartDefaultResponse, TError = unknown, TQueryKey extends Array<unknown> = unknown[]>(clientOptions: Options<GetAuthOauthStartData, true> = {}, queryKey?: TQueryKey, options?: Omit<UseQueryOptions<TData, TError>, "queryKey" | "queryFn">) => useQuery<TData, TError>({ queryKey: Common.UseGetAuthOauthStartKeyFn(clientOptions, queryKey), queryFn: ({ signal }) => getAuthOauthStart({ ...clientOptions, signal, throwOnError: true }).then(response => response.data as TData) as TData, ...options });
/**
 * OAuth authorization code callback — redirects with the session token in the URL fragment
 */
export const useGetAuthCallback = <TData = Common.GetAuthCallbackDefaultResponse, TError = unknown, TQueryKey extends Array<unknown> = unknown[]>(clientOptions: Options<GetAuthCallbackData, true> = {}, queryKey?: TQueryKey, options?: Omit<UseQueryOptions<TData, TError>, "queryKey" | "queryFn">) => useQuery<TData, TError>({ queryKey: Common.UseGetAuthCallbackKeyFn(clientOptions, queryKey), queryFn: ({ signal }) => getAuthCallback({ ...clientOptions, signal, throwOnError: true }).then(response => response.data as TData) as TData, ...options });
...
/**
 * Screen tint color per liquid biome id, as [r, g, b] in 0..1
 */
export const useGetApiBiomesTints = <TData = Common.GetApiBiomesTintsDefaultResponse, TError = unknown, TQueryKey extends Array<unknown> = unknown[]>(clientOptions: Options<GetApiBiomesTintsData, true> = {}, queryKey?: TQueryKey, options?: Omit<UseQueryOptions<TData, TError>, "queryKey" | "queryFn">) => useQuery<TData, TError>({ queryKey: Common.UseGetApiBiomesTintsKeyFn(clientOptions, queryKey), queryFn: ({ signal }) => getApiBiomesTints({ ...clientOptions, signal, throwOnError: true }).then(response => response.data as TData) as TData, ...options });
/**
 ...
 */
export const useGetApiPlayerByIdOwned = <TData = Common.GetApiPlayerByIdOwnedDefaultResponse, TError = unknown, TQueryKey extends Array<unknown> = unknown[]>(clientOptions: Options<GetApiPlayerByIdOwnedData, true>, queryKey?: TQueryKey, options?: Omit<UseQueryOptions<TData, TError>, "queryKey" | "queryFn">) => useQuery<TData, TError>({ queryKey: Common.UseGetApiPlayerByIdOwnedKeyFn(clientOptions, queryKey), queryFn: ({ signal }) => getApiPlayerByIdOwned({ ...clientOptions, signal, throwOnError: true }).then(response => response.data as TData) as TData, ...options });
/**
...
/**
 * Vehicle model config (speed, seat offset) for a named vehicle
 */
export const useGetApiVehiclesByNameConfig = <TData = Common.GetApiVehiclesByNameConfigDefaultResponse, TError = unknown, TQueryKey extends Array<unknown> = unknown[]>(clientOptions: Options<GetApiVehiclesByNameConfigData, true>, queryKey?: TQueryKey, options?: Omit<UseQueryOptions<TData, TError>, "queryKey" | "queryFn">) => useQuery<TData, TError>({ queryKey: Common.UseGetApiVehiclesByNameConfigKeyFn(clientOptions, queryKey), queryFn: ({ signal }) => getApiVehiclesByNameConfig({ ...clientOptions, signal, throwOnError: true }).then(response => response.data as TData) as TData, ...options });
/**
...
/**
 * List all registered mini-games (id, display name, bundle URL)
 */
export const useGetApiMinigames = <TData = Common.GetApiMinigamesDefaultResponse, TError = unknown, TQueryKey extends Array<unknown> = unknown[]>(clientOptions: Options<GetApiMinigamesData, true> = {}, queryKey?: TQueryKey, options?: Omit<UseQueryOptions<TData, TError>, "queryKey" | "queryFn">) => useQuery<TData, TError>({ queryKey: Common.UseGetApiMinigamesKeyFn(clientOptions, queryKey), queryFn: ({ signal }) => getApiMinigames({ ...clientOptions, signal, throwOnError: true }).then(response => response.data as TData) as TData, ...options });
/**
...
/**
 * List all siege weapon definitions
 */
export const useGetApiSiegeWeapons = <TData = Common.GetApiSiegeWeaponsDefaultResponse, TError = unknown, TQueryKey extends Array<unknown> = unknown[]>(clientOptions: Options<GetApiSiegeWeaponsData, true> = {}, queryKey?: TQueryKey, options?: Omit<UseQueryOptions<TData, TError>, "queryKey" | "queryFn">) => useQuery<TData, TError>({ queryKey: Common.UseGetApiSiegeWeaponsKeyFn(clientOptions, queryKey), queryFn: ({ signal }) => getApiSiegeWeapons({ ...clientOptions, signal, throwOnError: true }).then(response => response.data as TData) as TData, ...options });
/**
 * List all furniture definitions
 */
export const useGetApiFurnitures = <TData = Common.GetApiFurnituresDefaultResponse, TError = unknown, TQueryKey extends Array<unknown> = unknown[]>(clientOptions: Options<GetApiFurnituresData, true> = {}, queryKey?: TQueryKey, options?: Omit<UseQueryOptions<TData, TError>, "queryKey" | "queryFn">) => useQuery<TData, TError>({ queryKey: Common.UseGetApiFurnituresKeyFn(clientOptions, queryKey), queryFn: ({ signal }) => getApiFurnitures({ ...clientOptions, signal, throwOnError: true }).then(response => response.data as TData) as TData, ...options });
/**
 * List all auction listings, any status
 */
export const useGetApiAdminAuctions = <TData = Common.GetApiAdminAuctionsDefaultResponse, TError = unknown, TQueryKey extends Array<unknown> = unknown[]>(clientOptions: Options<GetApiAdminAuctionsData, true> = {}, queryKey?: TQueryKey, options?: Omit<UseQueryOptions<TData, TError>, "queryKey" | "queryFn">) => useQuery<TData, TError>({ queryKey: Common.UseGetApiAdminAuctionsKeyFn(clientOptions, queryKey), queryFn: ({ signal }) => getApiAdminAuctions({ ...clientOptions, signal, throwOnError: true }).then(response => response.data as TData) as TData, ...options });
/**
...
/**
 * Every known permission string — slash commands' `permission` field (discovered live from the command registry) plus the fixed set checked outside the command system. For autocomplete, not validation — a group may still be given any free-form permission string.
 */
export const useGetApiAdminPermissions = <TData = Common.GetApiAdminPermissionsDefaultResponse, TError = unknown, TQueryKey extends Array<unknown> = unknown[]>(clientOptions: Options<GetApiAdminPermissionsData, true> = {}, queryKey?: TQueryKey, options?: Omit<UseQueryOptions<TData, TError>, "queryKey" | "queryFn">) => useQuery<TData, TError>({ queryKey: Common.UseGetApiAdminPermissionsKeyFn(clientOptions, queryKey), queryFn: ({ signal }) => getApiAdminPermissions({ ...clientOptions, signal, throwOnError: true }).then(response => response.data as TData) as TData, ...options });
/**
 * All permission groups, including the virtual admin group
 */
export const useGetApiAdminGroups = <TData = Common.GetApiAdminGroupsDefaultResponse, TError = unknown, TQueryKey extends Array<unknown> = unknown[]>(clientOptions: Options<GetApiAdminGroupsData, true> = {}, queryKey?: TQueryKey, options?: Omit<UseQueryOptions<TData, TError>, "queryKey" | "queryFn">) => useQuery<TData, TError>({ queryKey: Common.UseGetApiAdminGroupsKeyFn(clientOptions, queryKey), queryFn: ({ signal }) => getApiAdminGroups({ ...clientOptions, signal, throwOnError: true }).then(response => response.data as TData) as TData, ...options });
/**
 * All player names
 */
...
/**
 * A character's in-game RBAC groups — distinct from the account-level groups on /api/admin/users, which only gate this admin panel
 */
export const useGetApiAdminPlayersByNameGroups = <TData = Common.GetApiAdminPlayersByNameGroupsDefaultResponse, TError = unknown, TQueryKey extends Array<unknown> = unknown[]>(clientOptions: Options<GetApiAdminPlayersByNameGroupsData, true>, queryKey?: TQueryKey, options?: Omit<UseQueryOptions<TData, TError>, "queryKey" | "queryFn">) => useQuery<TData, TError>({ queryKey: Common.UseGetApiAdminPlayersByNameGroupsKeyFn(clientOptions, queryKey), queryFn: ({ signal }) => getApiAdminPlayersByNameGroups({ ...clientOptions, signal, throwOnError: true }).then(response => response.data as TData) as TData, ...options });
/**
...
/**
 * All known loggers (Logback's registry) with their explicit and effective level — useful to raise verbosity for live debugging
 */
export const useGetApiAdminLoggers = <TData = Common.GetApiAdminLoggersDefaultResponse, TError = unknown, TQueryKey extends Array<unknown> = unknown[]>(clientOptions: Options<GetApiAdminLoggersData, true> = {}, queryKey?: TQueryKey, options?: Omit<UseQueryOptions<TData, TError>, "queryKey" | "queryFn">) => useQuery<TData, TError>({ queryKey: Common.UseGetApiAdminLoggersKeyFn(clientOptions, queryKey), queryFn: ({ signal }) => getApiAdminLoggers({ ...clientOptions, signal, throwOnError: true }).then(response => response.data as TData) as TData, ...options });
/**
 ...
 * All land claims
 */
export const useGetApiAdminClaims = <TData = Common.GetApiAdminClaimsDefaultResponse, TError = unknown, TQueryKey extends Array<unknown> = unknown[]>(clientOptions: Options<GetApiAdminClaimsData, true> = {}, queryKey?: TQueryKey, options?: Omit<UseQueryOptions<TData, TError>, "queryKey" | "queryFn">) => useQuery<TData, TError>({ queryKey: Common.UseGetApiAdminClaimsKeyFn(clientOptions, queryKey), queryFn: ({ signal }) => getApiAdminClaims({ ...clientOptions, signal, throwOnError: true }).then(response => response.data as TData) as TData, ...options });
/**
 * A single land claim
 */
export const useGetApiAdminClaimsById = <TData = Common.GetApiAdminClaimsByIdDefaultResponse, TError = unknown, TQueryKey extends Array<unknown> = unknown[]>(clientOptions: Options<GetApiAdminClaimsByIdData, true>, queryKey?: TQueryKey, options?: Omit<UseQueryOptions<TData, TError>, "queryKey" | "queryFn">) => useQuery<TData, TError>({ queryKey: Common.UseGetApiAdminClaimsByIdKeyFn(clientOptions, queryKey), queryFn: ({ signal }) => getApiAdminClaimsById({ ...clientOptions, signal, throwOnError: true }).then(response => response.data as TData) as TData, ...options });
/**
 ...
 */
export const useGetApiAdminSocialOnlinePlayers = <TData = Common.GetApiAdminSocialOnlinePlayersDefaultResponse, TError = unknown, TQueryKey extends Array<unknown> = unknown[]>(clientOptions: Options<GetApiAdminSocialOnlinePlayersData, true> = {}, queryKey?: TQueryKey, options?: Omit<UseQueryOptions<TData, TError>, "queryKey" | "queryFn">) => useQuery<TData, TError>({ queryKey: Common.UseGetApiAdminSocialOnlinePlayersKeyFn(clientOptions, queryKey), queryFn: ({ signal }) => getApiAdminSocialOnlinePlayers({ ...clientOptions, signal, throwOnError: true }).then(response => response.data as TData) as TData, ...options });
/**
 * Canonical display names of every known player (online + persisted), de-duplicated — for social name-field autocomplete
 */
export const useGetApiAdminSocialPlayers = <TData = Common.GetApiAdminSocialPlayersDefaultResponse, TError = unknown, TQueryKey extends Array<unknown> = unknown[]>(clientOptions: Options<GetApiAdminSocialPlayersData, true> = {}, queryKey?: TQueryKey, options?: Omit<UseQueryOptions<TData, TError>, "queryKey" | "queryFn">) => useQuery<TData, TError>({ queryKey: Common.UseGetApiAdminSocialPlayersKeyFn(clientOptions, queryKey), queryFn: ({ signal }) => getApiAdminSocialPlayers({ ...clientOptions, signal, throwOnError: true }).then(response => response.data as TData) as TData, ...options });
/**
 * All active player groups
 */
export const useGetApiAdminSocialGroups = <TData = Common.GetApiAdminSocialGroupsDefaultResponse, TError = unknown, TQueryKey extends Array<unknown> = unknown[]>(clientOptions: Options<GetApiAdminSocialGroupsData, true> = {}, queryKey?: TQueryKey, options?: Omit<UseQueryOptions<TData, TError>, "queryKey" | "queryFn">) => useQuery<TData, TError>({ queryKey: Common.UseGetApiAdminSocialGroupsKeyFn(clientOptions, queryKey), queryFn: ({ signal }) => getApiAdminSocialGroups({ ...clientOptions, signal, throwOnError: true }).then(response => response.data as TData) as TData, ...options });
/**
 * All guilds
 */
export const useGetApiAdminSocialGuilds = <TData = Common.GetApiAdminSocialGuildsDefaultResponse, TError = unknown, TQueryKey extends Array<unknown> = unknown[]>(clientOptions: Options<GetApiAdminSocialGuildsData, true> = {}, queryKey?: TQueryKey, options?: Omit<UseQueryOptions<TData, TError>, "queryKey" | "queryFn">) => useQuery<TData, TError>({ queryKey: Common.UseGetApiAdminSocialGuildsKeyFn(clientOptions, queryKey), queryFn: ({ signal }) => getApiAdminSocialGuilds({ ...clientOptions, signal, throwOnError: true }).then(response => response.data as TData) as TData, ...options });
/**
 * Faction settings and definitions
 */
export const useGetApiAdminSocialFactions = <TData = Common.GetApiAdminSocialFactionsDefaultResponse, TError = unknown, TQueryKey extends Array<unknown> = unknown[]>(clientOptions: Options<GetApiAdminSocialFactionsData, true> = {}, queryKey?: TQueryKey, options?: Omit<UseQueryOptions<TData, TError>, "queryKey" | "queryFn">) => useQuery<TData, TError>({ queryKey: Common.UseGetApiAdminSocialFactionsKeyFn(clientOptions, queryKey), queryFn: ({ signal }) => getApiAdminSocialFactions({ ...clientOptions, signal, throwOnError: true }).then(response => response.data as TData) as TData, ...options });
/**
 * Players affiliated with a faction (online + persisted)
 */
export const useGetApiAdminSocialFactionsByIdMembers = <TData = Common.GetApiAdminSocialFactionsByIdMembersDefaultResponse, TError = unknown, TQueryKey extends Array<unknown> = unknown[]>(clientOptions: Options<GetApiAdminSocialFactionsByIdMembersData, true>, queryKey?: TQueryKey, options?: Omit<UseQueryOptions<TData, TError>, "queryKey" | "queryFn">) => useQuery<TData, TError>({ queryKey: Common.UseGetApiAdminSocialFactionsByIdMembersKeyFn(clientOptions, queryKey), queryFn: ({ signal }) => getApiAdminSocialFactionsByIdMembers({ ...clientOptions, signal, throwOnError: true }).then(response => response.data as TData) as TData, ...options });
/**
...
/**
 * Log in with email/password (local auth provider)
 */
export const usePostAuthLogin = <TData = Common.PostAuthLoginMutationResult, TError = unknown, TQueryKey extends Array<unknown> = unknown[], TContext = unknown>(mutationKey?: TQueryKey, options?: Omit<UseMutationOptions<TData, TError, Options<PostAuthLoginData, true>, TContext>, "mutationKey" | "mutationFn">) => useMutation<TData, TError, Options<PostAuthLoginData, true>, TContext>({ mutationKey: Common.UsePostAuthLoginKeyFn(mutationKey), mutationFn: clientOptions => postAuthLogin({ ...clientOptions, throwOnError: true }) as unknown as Promise<TData>, ...options });
/**
 * Exchange a refresh token for a new access token + rotated refresh token
 */
export const usePostAuthRefresh = <TData = Common.PostAuthRefreshMutationResult, TError = unknown, TQueryKey extends Array<unknown> = unknown[], TContext = unknown>(mutationKey?: TQueryKey, options?: Omit<UseMutationOptions<TData, TError, Options<PostAuthRefreshData, true>, TContext>, "mutationKey" | "mutationFn">) => useMutation<TData, TError, Options<PostAuthRefreshData, true>, TContext>({ mutationKey: Common.UsePostAuthRefreshKeyFn(mutationKey), mutationFn: clientOptions => postAuthRefresh({ ...clientOptions, throwOnError: true }) as unknown as Promise<TData>, ...options });
 ...
 */
export const usePostApiAdminAuctionsByIdForceCancel = <TData = Common.PostApiAdminAuctionsByIdForceCancelMutationResult, TError = unknown, TQueryKey extends Array<unknown> = unknown[], TContext = unknown>(mutationKey?: TQueryKey, options?: Omit<UseMutationOptions<TData, TError, Options<PostApiAdminAuctionsByIdForceCancelData, true>, TContext>, "mutationKey" | "mutationFn">) => useMutation<TData, TError, Options<PostApiAdminAuctionsByIdForceCancelData, true>, TContext>({ mutationKey: Common.UsePostApiAdminAuctionsByIdForceCancelKeyFn(mutationKey), mutationFn: clientOptions => postApiAdminAuctionsByIdForceCancel({ ...clientOptions, throwOnError: true }) as unknown as Promise<TData>, ...options });
/**
...
/**
 * Reload configuration files without restarting the server — same behavior as the in-game /reload command
 */
export const usePostApiAdminReload = <TData = Common.PostApiAdminReloadMutationResult, TError = unknown, TQueryKey extends Array<unknown> = unknown[], TContext = unknown>(mutationKey?: TQueryKey, options?: Omit<UseMutationOptions<TData, TError, Options<PostApiAdminReloadData, true>, TContext>, "mutationKey" | "mutationFn">) => useMutation<TData, TError, Options<PostApiAdminReloadData, true>, TContext>({ mutationKey: Common.UsePostApiAdminReloadKeyFn(mutationKey), mutationFn: clientOptions => postApiAdminReload({ ...clientOptions, throwOnError: true }) as unknown as Promise<TData>, ...options });
/**
 ...
 */
export const usePostApiAdminGroups = <TData = Common.PostApiAdminGroupsMutationResult, TError = unknown, TQueryKey extends Array<unknown> = unknown[], TContext = unknown>(mutationKey?: TQueryKey, options?: Omit<UseMutationOptions<TData, TError, Options<PostApiAdminGroupsData, true>, TContext>, "mutationKey" | "mutationFn">) => useMutation<TData, TError, Options<PostApiAdminGroupsData, true>, TContext>({ mutationKey: Common.UsePostApiAdminGroupsKeyFn(mutationKey), mutationFn: clientOptions => postApiAdminGroups({ ...clientOptions, throwOnError: true }) as unknown as Promise<TData>, ...options });
/**
 * Delete a group and unassign it from every account and character that has it
 */
export const useDeleteApiAdminGroupsByName = <TData = Common.DeleteApiAdminGroupsByNameMutationResult, TError = unknown, TQueryKey extends Array<unknown> = unknown[], TContext = unknown>(mutationKey?: TQueryKey, options?: Omit<UseMutationOptions<TData, TError, Options<DeleteApiAdminGroupsByNameData, true>, TContext>, "mutationKey" | "mutationFn">) => useMutation<TData, TError, Options<DeleteApiAdminGroupsByNameData, true>, TContext>({ mutationKey: Common.UseDeleteApiAdminGroupsByNameKeyFn(mutationKey), mutationFn: clientOptions => deleteApiAdminGroupsByName({ ...clientOptions, throwOnError: true }) as unknown as Promise<TData>, ...options });
/**
 * Replace a group's permission list
 */
export const usePutApiAdminGroupsByName = <TData = Common.PutApiAdminGroupsByNameMutationResult, TError = unknown, TQueryKey extends Array<unknown> = unknown[], TContext = unknown>(mutationKey?: TQueryKey, options?: Omit<UseMutationOptions<TData, TError, Options<PutApiAdminGroupsByNameData, true>, TContext>, "mutationKey" | "mutationFn">) => useMutation<TData, TError, Options<PutApiAdminGroupsByNameData, true>, TContext>({ mutationKey: Common.UsePutApiAdminGroupsByNameKeyFn(mutationKey), mutationFn: clientOptions => putApiAdminGroupsByName({ ...clientOptions, throwOnError: true }) as unknown as Promise<TData>, ...options });
/**
 * Create a player identity in the target world and return its id. Reserves the id (and, with `characterClass`, a fresh RPG character) that `onConnect` will use — so an E2E test's RPG player is ready before the browser connects, with no character-creation screen. Also ensures the matching no-auth account exists. Does not write to persistence.
 */
export const usePostApiAdminPlayers = <TData = Common.PostApiAdminPlayersMutationResult, TError = unknown, TQueryKey extends Array<unknown> = unknown[], TContext = unknown>(mutationKey?: TQueryKey, options?: Omit<UseMutationOptions<TData, TError, Options<PostApiAdminPlayersData, true>, TContext>, "mutationKey" | "mutationFn">) => useMutation<TData, TError, Options<PostApiAdminPlayersData, true>, TContext>({ mutationKey: Common.UsePostApiAdminPlayersKeyFn(mutationKey), mutationFn: clientOptions => postApiAdminPlayers({ ...clientOptions, throwOnError: true }) as unknown as Promise<TData>, ...options });
/**
...
/**
 * Replace a character's in-game RBAC groups
 */
export const usePutApiAdminPlayersByNameGroups = <TData = Common.PutApiAdminPlayersByNameGroupsMutationResult, TError = unknown, TQueryKey extends Array<unknown> = unknown[], TContext = unknown>(mutationKey?: TQueryKey, options?: Omit<UseMutationOptions<TData, TError, Options<PutApiAdminPlayersByNameGroupsData, true>, TContext>, "mutationKey" | "mutationFn">) => useMutation<TData, TError, Options<PutApiAdminPlayersByNameGroupsData, true>, TContext>({ mutationKey: Common.UsePutApiAdminPlayersByNameGroupsKeyFn(mutationKey), mutationFn: clientOptions => putApiAdminPlayersByNameGroups({ ...clientOptions, throwOnError: true }) as unknown as Promise<TData>, ...options });
/**
 ...
 */
export const usePutApiAdminPlayersByNameEquipment = <TData = Common.PutApiAdminPlayersByNameEquipmentMutationResult, TError = unknown, TQueryKey extends Array<unknown> = unknown[], TContext = unknown>(mutationKey?: TQueryKey, options?: Omit<UseMutationOptions<TData, TError, Options<PutApiAdminPlayersByNameEquipmentData, true>, TContext>, "mutationKey" | "mutationFn">) => useMutation<TData, TError, Options<PutApiAdminPlayersByNameEquipmentData, true>, TContext>({ mutationKey: Common.UsePutApiAdminPlayersByNameEquipmentKeyFn(mutationKey), mutationFn: clientOptions => putApiAdminPlayersByNameEquipment({ ...clientOptions, throwOnError: true }) as unknown as Promise<TData>, ...options });
/**
 * Give an inventory item, or grant ownership of an armor/weapon/tool
 */
export const usePostApiAdminPlayersByNameGive = <TData = Common.PostApiAdminPlayersByNameGiveMutationResult, TError = unknown, TQueryKey extends Array<unknown> = unknown[], TContext = unknown>(mutationKey?: TQueryKey, options?: Omit<UseMutationOptions<TData, TError, Options<PostApiAdminPlayersByNameGiveData, true>, TContext>, "mutationKey" | "mutationFn">) => useMutation<TData, TError, Options<PostApiAdminPlayersByNameGiveData, true>, TContext>({ mutationKey: Common.UsePostApiAdminPlayersByNameGiveKeyFn(mutationKey), mutationFn: clientOptions => postApiAdminPlayersByNameGive({ ...clientOptions, throwOnError: true }) as unknown as Promise<TData>, ...options });
/**
 * Create a new world
 */
...
/**
 * Set a logger's level (TRACE/DEBUG/INFO/WARN/ERROR/OFF), or null to inherit from its parent again
 */
export const usePutApiAdminLoggersBy = <TData = Common.PutApiAdminLoggersByMutationResult, TError = unknown, TQueryKey extends Array<unknown> = unknown[], TContext = unknown>(mutationKey?: TQueryKey, options?: Omit<UseMutationOptions<TData, TError, Options<PutApiAdminLoggersByData, true>, TContext>, "mutationKey" | "mutationFn">) => useMutation<TData, TError, Options<PutApiAdminLoggersByData, true>, TContext>({ mutationKey: Common.UsePutApiAdminLoggersByKeyFn(mutationKey), mutationFn: clientOptions => putApiAdminLoggersBy({ ...clientOptions, throwOnError: true }) as unknown as Promise<TData>, ...options });
/**
 * Send a message to a live chat_npc's LLM dialogue outside of any real player session — for iterating on its dialoguePrompt
 */
export const usePostApiAdminNpcsByIdChatTest = <TData = Common.PostApiAdminNpcsByIdChatTestMutationResult, TError = unknown, TQueryKey extends Array<unknown> = unknown[], TContext = unknown>(mutationKey?: TQueryKey, options?: Omit<UseMutationOptions<TData, TError, Options<PostApiAdminNpcsByIdChatTestData, true>, TContext>, "mutationKey" | "mutationFn">) => useMutation<TData, TError, Options<PostApiAdminNpcsByIdChatTestData, true>, TContext>({ mutationKey: Common.UsePostApiAdminNpcsByIdChatTestKeyFn(mutationKey), mutationFn: clientOptions => postApiAdminNpcsByIdChatTest({ ...clientOptions, throwOnError: true }) as unknown as Promise<TData>, ...options });
/**
 ...
 * Delete a land claim
 */
export const useDeleteApiAdminClaimsById = <TData = Common.DeleteApiAdminClaimsByIdMutationResult, TError = unknown, TQueryKey extends Array<unknown> = unknown[], TContext = unknown>(mutationKey?: TQueryKey, options?: Omit<UseMutationOptions<TData, TError, Options<DeleteApiAdminClaimsByIdData, true>, TContext>, "mutationKey" | "mutationFn">) => useMutation<TData, TError, Options<DeleteApiAdminClaimsByIdData, true>, TContext>({ mutationKey: Common.UseDeleteApiAdminClaimsByIdKeyFn(mutationKey), mutationFn: clientOptions => deleteApiAdminClaimsById({ ...clientOptions, throwOnError: true }) as unknown as Promise<TData>, ...options });
/**
 * Update a claim's Y bounds
 */
export const usePutApiAdminClaimsByIdBounds = <TData = Common.PutApiAdminClaimsByIdBoundsMutationResult, TError = unknown, TQueryKey extends Array<unknown> = unknown[], TContext = unknown>(mutationKey?: TQueryKey, options?: Omit<UseMutationOptions<TData, TError, Options<PutApiAdminClaimsByIdBoundsData, true>, TContext>, "mutationKey" | "mutationFn">) => useMutation<TData, TError, Options<PutApiAdminClaimsByIdBoundsData, true>, TContext>({ mutationKey: Common.UsePutApiAdminClaimsByIdBoundsKeyFn(mutationKey), mutationFn: clientOptions => putApiAdminClaimsByIdBounds({ ...clientOptions, throwOnError: true }) as unknown as Promise<TData>, ...options });
/**
 * Grant or revoke a player's trust on a claim (online or offline)
 */
export const usePutApiAdminClaimsByIdTrust = <TData = Common.PutApiAdminClaimsByIdTrustMutationResult, TError = unknown, TQueryKey extends Array<unknown> = unknown[], TContext = unknown>(mutationKey?: TQueryKey, options?: Omit<UseMutationOptions<TData, TError, Options<PutApiAdminClaimsByIdTrustData, true>, TContext>, "mutationKey" | "mutationFn">) => useMutation<TData, TError, Options<PutApiAdminClaimsByIdTrustData, true>, TContext>({ mutationKey: Common.UsePutApiAdminClaimsByIdTrustKeyFn(mutationKey), mutationFn: clientOptions => putApiAdminClaimsByIdTrust({ ...clientOptions, throwOnError: true }) as unknown as Promise<TData>, ...options });
/**
 * Create a scene
 */
 ...
 */
export const usePostApiAdminSocialGroups = <TData = Common.PostApiAdminSocialGroupsMutationResult, TError = unknown, TQueryKey extends Array<unknown> = unknown[], TContext = unknown>(mutationKey?: TQueryKey, options?: Omit<UseMutationOptions<TData, TError, Options<PostApiAdminSocialGroupsData, true>, TContext>, "mutationKey" | "mutationFn">) => useMutation<TData, TError, Options<PostApiAdminSocialGroupsData, true>, TContext>({ mutationKey: Common.UsePostApiAdminSocialGroupsKeyFn(mutationKey), mutationFn: clientOptions => postApiAdminSocialGroups({ ...clientOptions, throwOnError: true }) as unknown as Promise<TData>, ...options });
/**
 * Add an online player to a group
 */
export const usePostApiAdminSocialGroupsByIdMembers = <TData = Common.PostApiAdminSocialGroupsByIdMembersMutationResult, TError = unknown, TQueryKey extends Array<unknown> = unknown[], TContext = unknown>(mutationKey?: TQueryKey, options?: Omit<UseMutationOptions<TData, TError, Options<PostApiAdminSocialGroupsByIdMembersData, true>, TContext>, "mutationKey" | "mutationFn">) => useMutation<TData, TError, Options<PostApiAdminSocialGroupsByIdMembersData, true>, TContext>({ mutationKey: Common.UsePostApiAdminSocialGroupsByIdMembersKeyFn(mutationKey), mutationFn: clientOptions => postApiAdminSocialGroupsByIdMembers({ ...clientOptions, throwOnError: true }) as unknown as Promise<TData>, ...options });
/**
 * Remove a member from a group
 */
export const useDeleteApiAdminSocialGroupsByIdMembersByPlayerId = <TData = Common.DeleteApiAdminSocialGroupsByIdMembersByPlayerIdMutationResult, TError = unknown, TQueryKey extends Array<unknown> = unknown[], TContext = unknown>(mutationKey?: TQueryKey, options?: Omit<UseMutationOptions<TData, TError, Options<DeleteApiAdminSocialGroupsByIdMembersByPlayerIdData, true>, TContext>, "mutationKey" | "mutationFn">) => useMutation<TData, TError, Options<DeleteApiAdminSocialGroupsByIdMembersByPlayerIdData, true>, TContext>({ mutationKey: Common.UseDeleteApiAdminSocialGroupsByIdMembersByPlayerIdKeyFn(mutationKey), mutationFn: clientOptions => deleteApiAdminSocialGroupsByIdMembersByPlayerId({ ...clientOptions, throwOnError: true }) as unknown as Promise<TData>, ...options });
/**
 * Disband a group
 */
export const useDeleteApiAdminSocialGroupsById = <TData = Common.DeleteApiAdminSocialGroupsByIdMutationResult, TError = unknown, TQueryKey extends Array<unknown> = unknown[], TContext = unknown>(mutationKey?: TQueryKey, options?: Omit<UseMutationOptions<TData, TError, Options<DeleteApiAdminSocialGroupsByIdData, true>, TContext>, "mutationKey" | "mutationFn">) => useMutation<TData, TError, Options<DeleteApiAdminSocialGroupsByIdData, true>, TContext>({ mutationKey: Common.UseDeleteApiAdminSocialGroupsByIdKeyFn(mutationKey), mutationFn: clientOptions => deleteApiAdminSocialGroupsById({ ...clientOptions, throwOnError: true }) as unknown as Promise<TData>, ...options });
/**
 * Create a guild
 */
export const usePostApiAdminSocialGuilds = <TData = Common.PostApiAdminSocialGuildsMutationResult, TError = unknown, TQueryKey extends Array<unknown> = unknown[], TContext = unknown>(mutationKey?: TQueryKey, options?: Omit<UseMutationOptions<TData, TError, Options<PostApiAdminSocialGuildsData, true>, TContext>, "mutationKey" | "mutationFn">) => useMutation<TData, TError, Options<PostApiAdminSocialGuildsData, true>, TContext>({ mutationKey: Common.UsePostApiAdminSocialGuildsKeyFn(mutationKey), mutationFn: clientOptions => postApiAdminSocialGuilds({ ...clientOptions, throwOnError: true }) as unknown as Promise<TData>, ...options });
/**
 * Disband a guild
 */
export const useDeleteApiAdminSocialGuildsById = <TData = Common.DeleteApiAdminSocialGuildsByIdMutationResult, TError = unknown, TQueryKey extends Array<unknown> = unknown[], TContext = unknown>(mutationKey?: TQueryKey, options?: Omit<UseMutationOptions<TData, TError, Options<DeleteApiAdminSocialGuildsByIdData, true>, TContext>, "mutationKey" | "mutationFn">) => useMutation<TData, TError, Options<DeleteApiAdminSocialGuildsByIdData, true>, TContext>({ mutationKey: Common.UseDeleteApiAdminSocialGuildsByIdKeyFn(mutationKey), mutationFn: clientOptions => deleteApiAdminSocialGuildsById({ ...clientOptions, throwOnError: true }) as unknown as Promise<TData>, ...options });
/**
 * Rename / retag / set MOTD of a guild
 */
export const usePutApiAdminSocialGuildsById = <TData = Common.PutApiAdminSocialGuildsByIdMutationResult, TError = unknown, TQueryKey extends Array<unknown> = unknown[], TContext = unknown>(mutationKey?: TQueryKey, options?: Omit<UseMutationOptions<TData, TError, Options<PutApiAdminSocialGuildsByIdData, true>, TContext>, "mutationKey" | "mutationFn">) => useMutation<TData, TError, Options<PutApiAdminSocialGuildsByIdData, true>, TContext>({ mutationKey: Common.UsePutApiAdminSocialGuildsByIdKeyFn(mutationKey), mutationFn: clientOptions => putApiAdminSocialGuildsById({ ...clientOptions, throwOnError: true }) as unknown as Promise<TData>, ...options });
/**
 * Add a player to a guild
 */
export const usePostApiAdminSocialGuildsByIdMembers = <TData = Common.PostApiAdminSocialGuildsByIdMembersMutationResult, TError = unknown, TQueryKey extends Array<unknown> = unknown[], TContext = unknown>(mutationKey?: TQueryKey, options?: Omit<UseMutationOptions<TData, TError, Options<PostApiAdminSocialGuildsByIdMembersData, true>, TContext>, "mutationKey" | "mutationFn">) => useMutation<TData, TError, Options<PostApiAdminSocialGuildsByIdMembersData, true>, TContext>({ mutationKey: Common.UsePostApiAdminSocialGuildsByIdMembersKeyFn(mutationKey), mutationFn: clientOptions => postApiAdminSocialGuildsByIdMembers({ ...clientOptions, throwOnError: true }) as unknown as Promise<TData>, ...options });
/**
 * Remove a member from a guild
 */
export const useDeleteApiAdminSocialGuildsByIdMembersByPlayerId = <TData = Common.DeleteApiAdminSocialGuildsByIdMembersByPlayerIdMutationResult, TError = unknown, TQueryKey extends Array<unknown> = unknown[], TContext = unknown>(mutationKey?: TQueryKey, options?: Omit<UseMutationOptions<TData, TError, Options<DeleteApiAdminSocialGuildsByIdMembersByPlayerIdData, true>, TContext>, "mutationKey" | "mutationFn">) => useMutation<TData, TError, Options<DeleteApiAdminSocialGuildsByIdMembersByPlayerIdData, true>, TContext>({ mutationKey: Common.UseDeleteApiAdminSocialGuildsByIdMembersByPlayerIdKeyFn(mutationKey), mutationFn: clientOptions => deleteApiAdminSocialGuildsByIdMembersByPlayerId({ ...clientOptions, throwOnError: true }) as unknown as Promise<TData>, ...options });
/**
 * Set a guild member's rank
 */
export const usePutApiAdminSocialGuildsByIdMembersByPlayerId = <TData = Common.PutApiAdminSocialGuildsByIdMembersByPlayerIdMutationResult, TError = unknown, TQueryKey extends Array<unknown> = unknown[], TContext = unknown>(mutationKey?: TQueryKey, options?: Omit<UseMutationOptions<TData, TError, Options<PutApiAdminSocialGuildsByIdMembersByPlayerIdData, true>, TContext>, "mutationKey" | "mutationFn">) => useMutation<TData, TError, Options<PutApiAdminSocialGuildsByIdMembersByPlayerIdData, true>, TContext>({ mutationKey: Common.UsePutApiAdminSocialGuildsByIdMembersByPlayerIdKeyFn(mutationKey), mutationFn: clientOptions => putApiAdminSocialGuildsByIdMembersByPlayerId({ ...clientOptions, throwOnError: true }) as unknown as Promise<TData>, ...options });
/**
 * Create or replace a faction definition (matched by id)
 */
export const usePostApiAdminSocialFactions = <TData = Common.PostApiAdminSocialFactionsMutationResult, TError = unknown, TQueryKey extends Array<unknown> = unknown[], TContext = unknown>(mutationKey?: TQueryKey, options?: Omit<UseMutationOptions<TData, TError, Options<PostApiAdminSocialFactionsData, true>, TContext>, "mutationKey" | "mutationFn">) => useMutation<TData, TError, Options<PostApiAdminSocialFactionsData, true>, TContext>({ mutationKey: Common.UsePostApiAdminSocialFactionsKeyFn(mutationKey), mutationFn: clientOptions => postApiAdminSocialFactions({ ...clientOptions, throwOnError: true }) as unknown as Promise<TData>, ...options });
/**
 * Update global faction settings
 */
export const usePutApiAdminSocialFactionsSettings = <TData = Common.PutApiAdminSocialFactionsSettingsMutationResult, TError = unknown, TQueryKey extends Array<unknown> = unknown[], TContext = unknown>(mutationKey?: TQueryKey, options?: Omit<UseMutationOptions<TData, TError, Options<PutApiAdminSocialFactionsSettingsData, true>, TContext>, "mutationKey" | "mutationFn">) => useMutation<TData, TError, Options<PutApiAdminSocialFactionsSettingsData, true>, TContext>({ mutationKey: Common.UsePutApiAdminSocialFactionsSettingsKeyFn(mutationKey), mutationFn: clientOptions => putApiAdminSocialFactionsSettings({ ...clientOptions, throwOnError: true }) as unknown as Promise<TData>, ...options });
/**
 * Delete a faction definition
 */
export const useDeleteApiAdminSocialFactionsById = <TData = Common.DeleteApiAdminSocialFactionsByIdMutationResult, TError = unknown, TQueryKey extends Array<unknown> = unknown[], TContext = unknown>(mutationKey?: TQueryKey, options?: Omit<UseMutationOptions<TData, TError, Options<DeleteApiAdminSocialFactionsByIdData, true>, TContext>, "mutationKey" | "mutationFn">) => useMutation<TData, TError, Options<DeleteApiAdminSocialFactionsByIdData, true>, TContext>({ mutationKey: Common.UseDeleteApiAdminSocialFactionsByIdKeyFn(mutationKey), mutationFn: clientOptions => deleteApiAdminSocialFactionsById({ ...clientOptions, throwOnError: true }) as unknown as Promise<TData>, ...options });
/**
 * Make a player join a faction (admin — no cooldown)
 */
export const usePostApiAdminSocialFactionsByIdMembers = <TData = Common.PostApiAdminSocialFactionsByIdMembersMutationResult, TError = unknown, TQueryKey extends Array<unknown> = unknown[], TContext = unknown>(mutationKey?: TQueryKey, options?: Omit<UseMutationOptions<TData, TError, Options<PostApiAdminSocialFactionsByIdMembersData, true>, TContext>, "mutationKey" | "mutationFn">) => useMutation<TData, TError, Options<PostApiAdminSocialFactionsByIdMembersData, true>, TContext>({ mutationKey: Common.UsePostApiAdminSocialFactionsByIdMembersKeyFn(mutationKey), mutationFn: clientOptions => postApiAdminSocialFactionsByIdMembers({ ...clientOptions, throwOnError: true }) as unknown as Promise<TData>, ...options });
/**
 * Remove a player from a faction
 */
export const useDeleteApiAdminSocialFactionsByIdMembersByPlayerId = <TData = Common.DeleteApiAdminSocialFactionsByIdMembersByPlayerIdMutationResult, TError = unknown, TQueryKey extends Array<unknown> = unknown[], TContext = unknown>(mutationKey?: TQueryKey, options?: Omit<UseMutationOptions<TData, TError, Options<DeleteApiAdminSocialFactionsByIdMembersByPlayerIdData, true>, TContext>, "mutationKey" | "mutationFn">) => useMutation<TData, TError, Options<DeleteApiAdminSocialFactionsByIdMembersByPlayerIdData, true>, TContext>({ mutationKey: Common.UseDeleteApiAdminSocialFactionsByIdMembersByPlayerIdKeyFn(mutationKey), mutationFn: clientOptions => deleteApiAdminSocialFactionsByIdMembersByPlayerId({ ...clientOptions, throwOnError: true }) as unknown as Promise<TData>, ...options });
/**
 * Reload NPC type definitions from resources/entities and despawn live instances so the spawner recreates them with the new model. Use after editing an entity bbmodel/yaml.
 */
export const usePostApiAdminNpcTypesReload = <TData = Common.PostApiAdminNpcTypesReloadMutationResult, TError = unknown, TQueryKey extends Array<unknown> = unknown[], TContext = unknown>(mutationKey?: TQueryKey, options?: Omit<UseMutationOptions<TData, TError, Options<PostApiAdminNpcTypesReloadData, true>, TContext>, "mutationKey" | "mutationFn">) => useMutation<TData, TError, Options<PostApiAdminNpcTypesReloadData, true>, TContext>({ mutationKey: Common.UsePostApiAdminNpcTypesReloadKeyFn(mutationKey), mutationFn: clientOptions => postApiAdminNpcTypesReload({ ...clientOptions, throwOnError: true }) as unknown as Promise<TData>, ...options });
