...
export const en = {
  ...
  "rbac.countOne": "{0} group",
  "rbac.countMany": "{0} groups",
  "rbac.add": "+ Add Group",
  "rbac.name": "Name",
  "rbac.namePlaceholder": "moderator",
  "rbac.permissions": "Permissions",
  "rbac.noPermissions": "No permissions",
  "rbac.noPermissionsMatch": "No permission matches",
  "rbac.filterPermissions": "Filter permissions…",
  "rbac.permissionPlaceholder": "action.fly",
  "rbac.addPermission": "Add",
  "rbac.removePermission": "Remove permission",
  "rbac.default": "default",
  "rbac.builtin": "built-in",
  "rbac.backToList": "← Back to groups",
  "rbac.notFound": "Group not found.",
  "rbac.addTitle": "Add Group",
  "rbac.editTitle": "Edit Group Permissions",
  "rbac.deleteTitle": "Delete Group",
  "rbac.deleteConfirmBefore": "Delete",
  "rbac.deleteConfirmAfter": "? Users in this group lose its permissions immediately. This cannot be undone.",
  "rbac.requiresLocal": "Group management requires",
  "rbac.requiresLocalOr": "or",
  ...
  "administration.tabFurnitures": "Furniture",
  "administration.furnitureBbmodelFile": "Model file",
  "administration.furnitureWidth": "Width",
  "administration.furnitureHeight": "Height",
  "administration.furnitureRotatable": "Rotatable",
