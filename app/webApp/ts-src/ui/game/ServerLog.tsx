...
export function ServerLog({
  ...
  return (
    <div style={containerStyle}>
      ...
      <div style={{ flex: 1, overflowY: "auto", padding: "4px 8px", minHeight: 0 }} ref={scrollRef} onScroll={onScroll}>
        {filtered.length === 0 && (
        ...
        {filtered.map((entry, i) => (
          <div key={i} style={{ color: "#ddd", font: "12px/1.6 monospace" }}>
            ...
            {entry.sender && (
              <span style={{ color: channelColor(entry.channel), fontWeight: "bold" }}>
