...
export function Hotbar({ inventory, visible }: Props) {
  ...
  return (
    <div style={{
      ...
      display: 'flex', gap: 4, pointerEvents: 'none', zIndex: 998, alignItems: 'center',
      background: 'rgba(0,0,0,0.6)', border: '1px solid rgba(255,255,255,0.2)',
      borderRadius: 6, padding: '6px 10px', minWidth: 120, minHeight: 68,
    }}>
      {items.length === 0 ? (
        ...
        <div key={type} style={{
          width: 52, height: 52, background: 'rgba(0,0,0,0.72)',
          border: '2px solid rgba(255,255,255,0.45)', borderRadius: 4,
          ...
          <div style={{ color: 'rgba(255,255,255,0.7)', font: '8px monospace', marginTop: 3, letterSpacing: '0.5px' }}>
            {meta.label}
          </div>
          <div style={{ position: 'absolute', bottom: 2, right: 4, color: '#fff', font: 'bold 10px monospace', textShadow: '1px 1px 0 #000' }}>
            {count}
          </div>
        </div>
      ))}
