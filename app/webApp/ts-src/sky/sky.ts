export function registerSky(): void {
  ...
  const SKY_STOPS: Array<[number, [number, number, number]]> = [
    ...
    [0.25, [0.95, 0.70, 0.40]],  // dawn
    [0.33, [0.53, 0.81, 0.98]],  // morning
    [0.67, [0.53, 0.81, 0.98]],  // afternoon
    [0.75, [0.90, 0.55, 0.20]],  // dusk
    [0.80, [0.03, 0.03, 0.10]],  // evening
  ...
  window.mcUpdateSkyTime = (scene: any, t: number): void => {
    if (!sun) {
