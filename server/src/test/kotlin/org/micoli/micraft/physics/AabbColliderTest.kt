...
class AabbColliderTest {
    ...
    fun isGrounded_solidBelow_returnsTrue() {
        ...
        assertTrue(AabbCollider.isGrounded(world, 8.5f, 5f, 8.5f, w))
    }

    @Test
    fun isGrounded_airBelow_returnsFalse() {
        val world = testWorld()
        assertFalse(AabbCollider.isGrounded(world, 8.5f, 5f, 8.5f, w))
    }
    ...
    fun resolveX_zero_returnsZero() {
        val world = testWorld()
        val result = AabbCollider.resolveX(world, 8.5f, 5f, 8.5f, w, h, 0f)
    ...
    fun resolveX_positive_noObstacle_returnsFullDx() {
        val world = testWorld()
        val dx = 0.3f
        val result = AabbCollider.resolveX(world, 8.5f, 5f, 8.5f, w, h, dx)
    ...
    fun resolveX_positive_stopsAtWall() {
        ...
        val result = AabbCollider.resolveX(world, 9.5f, 5f, 8.5f, w, h, 1.0f)
    ...
    fun resolveX_negative_stopsAtWall() {
        ...
        val result = AabbCollider.resolveX(world, 8.5f, 5f, 8.5f, w, h, -1.0f)
        assertTrue(result > -1.0f)
    ...
    fun resolveZ_zero_returnsZero() {
        val world = testWorld()
        val result = AabbCollider.resolveZ(world, 8.5f, 5f, 8.5f, w, h, 0f)
        assertTrue(result == 0f)
    }
    ...
    fun resolveZ_positive_noObstacle_returnsFullDz() {
        val world = testWorld()
        val dz = 0.3f
        val result = AabbCollider.resolveZ(world, 8.5f, 5f, 8.5f, w, h, dz)
    ...
    fun resolveZ_positive_stopsAtWall() {
        ...
        val result = AabbCollider.resolveZ(world, 8.5f, 5f, 9.5f, w, h, 1.0f)
        assertTrue(result < 1.0f)
    }
    ...
    fun resolveY_zero_returnsZero() {
        val world = testWorld()
        val result = AabbCollider.resolveY(world, 8.5f, 5f, 8.5f, w, h, 0f)
        assertTrue(result == 0f)
    }
    ...
    fun resolveY_falling_landsOnBlock() {
        ...
        val result = AabbCollider.resolveY(world, 8.5f, 5f, 8.5f, w, h, -3f)
    ...
    fun resolveY_noObstacle_returnsFullDy() {
        val world = testWorld()
        val dy = -2f
        val result = AabbCollider.resolveY(world, 8.5f, 5f, 8.5f, w, h, dy)
    ...
    fun canAdoptStance_shrinking_alwaysTrue() {
        ...
        val result = AabbCollider.canAdoptStance(world, 8.5f, 5f, 8.5f, w, newH = 1.5f, currentH = 1.8f)
        assertTrue(result)
    }
    ...
    fun canAdoptStance_growing_clearSpace_returnsTrue() {
        val world = testWorld()
        val result = AabbCollider.canAdoptStance(world, 8.5f, 5f, 8.5f, w, newH = 1.8f, currentH = 1.5f)
        assertTrue(result)
    }
