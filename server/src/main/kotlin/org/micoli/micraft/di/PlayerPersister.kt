...
/**
 * Extracted from [org.micoli.micraft.GameLoop] so collaborators built as Koin singletons can save
 * player state without depending on GameLoop's own private method.
 */
