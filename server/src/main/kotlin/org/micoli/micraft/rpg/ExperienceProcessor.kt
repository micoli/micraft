    ...
    suspend fun onNpcKilled(npc: NpcInstance) {
        ...
        val baseXp =
            when (npc.definition.tier) {
                org.micoli.micraft.npc.NpcTier.COMMON -> config.sources.commonPerLevel
                org.micoli.micraft.npc.NpcTier.ELITE -> config.sources.elitePerLevel
                org.micoli.micraft.npc.NpcTier.BOSS -> config.sources.bossPerLevel
            } * npc.definition.level
