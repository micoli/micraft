...
class NpcRegistryLoader(private val path: Path) {
    ...
    fun load(): Map<String, NpcDefinition> {
        ...
        val result = raw.entries.mapNotNull { (key, entry) ->
            ...
            }.onFailure { e -> log.warn("Skipping NPC type '{}' in npcs.yaml: {}", key, e.message) }.getOrNull()
        }.toMap()
