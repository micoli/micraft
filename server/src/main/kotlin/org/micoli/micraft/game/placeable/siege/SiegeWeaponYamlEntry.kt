...
data class SiegeWeaponYamlEntry(
    ...
    @JsonSchemaConstraint(minimum = 0.0) val launchPowerMin: Float = 0f,
    @JsonSchemaConstraint(minimum = 0.0) val launchPowerMax: Float = 100f,
    val launchPitchDeg: Float = 45f,
    @JsonSchemaConstraint(minimum = -90.0, maximum = 90.0) val launchPitchDegMin: Float = 0f,
    @JsonSchemaConstraint(minimum = -90.0, maximum = 90.0) val launchPitchDegMax: Float = 90f,
...
data class SiegeWeaponYamlOverride(
    ...
    val launchPowerMin: Float? = null,
    val launchPowerMax: Float? = null,
    val launchPitchDeg: Float? = null,
    val launchPitchDegMin: Float? = null,
    val launchPitchDegMax: Float? = null,
