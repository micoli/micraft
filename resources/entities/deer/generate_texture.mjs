// Regenerable generator for the `deer` NPC: builds geometry (<type>.bbmodel) and paints
...
//   make dc CMD="node resources/entities/deer/generate_texture.mjs"
...
const PARTS = {
  body: [-4, 10, -6, 4, 16, 6, "body"],
  neck: [-2, 15, -9, 2, 22, -5, "neck"],
  head: [-2, 20, -12, 2, 24, -6, "head"],
  earL: [-5, 23, -9, -3, 26, -8, "ear"],
  earR: [3, 23, -9, 5, 26, -8, "ear"],
  tail: [-1, 13, 6, 1, 16, 8, "tail"],
  legFL: [-4, 0, -5, -2, 10, -3, "leg"],
  legFR: [2, 0, -5, 4, 10, -3, "leg"],
  legBL: [-4, 0, 3, -2, 10, 5, "leg"],
  legBR: [2, 0, 3, 4, 10, 5, "leg"],
};

// bone -> {origin, rotation, children:[elementNames], parent}
const BONES = {
  body: { origin: [0, 13, 0], rotation: [0, 0, 0], elems: ["body"] },
  neck: { origin: [0, 15, -5], rotation: [0, 0, 0], elems: ["neck"], parent: "body" },
  head: { origin: [0, 21, -8], rotation: [0, 0, 0], elems: ["head"], parent: "neck" },
  earL: { origin: [-3, 24, -8], rotation: [0, 0, -20], elems: ["earL"], parent: "head" },
  earR: { origin: [3, 24, -8], rotation: [0, 0, 20], elems: ["earR"], parent: "head" },
  tail: { origin: [0, 16, 6], rotation: [-25, 0, 0], elems: ["tail"], parent: "body" },
  frontLegL: { origin: [-3, 10, -4], rotation: [0, 0, 0], elems: ["legFL"], parent: "body" },
  frontLegR: { origin: [3, 10, -4], rotation: [0, 0, 0], elems: ["legFR"], parent: "body" },
  backLegL: { origin: [-3, 10, 4], rotation: [0, 0, 0], elems: ["legBL"], parent: "body" },
  backLegR: { origin: [3, 10, 4], rotation: [0, 0, 0], elems: ["legBR"], parent: "body" },
};
